        ...
        <div className="bg-slate-900 text-white rounded-xl shadow-lg p-3 sm:p-4 border border-slate-800 flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="text-xs text-amber-400 hover:text-amber-300 underline font-medium cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500"
