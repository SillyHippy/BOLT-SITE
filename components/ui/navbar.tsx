    ...
    <nav className="fixed top-0 left-0 right-0 z-40 bg-white shadow-sm" aria-label="Main navigation">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          {/* Desktop Navigation */}
          {/* ⚡ Bolt Optimization: Disabled prefetching for desktop navbar links
              to prevent downloading all route payloads simultaneously when the
              navbar mounts on every page. Expected impact: Reduces unnecessary
              background network requests on initial load. */}
