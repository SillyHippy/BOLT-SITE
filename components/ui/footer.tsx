...
export function Footer() {
  ...
  const uploadFilesToDrive = async (clientName: string, caseNumber: string, email: string, notes: string) => {
    ...
    try {
      ...
      // ⚡ Bolt Optimization: Replace sequential for...of with Promise.all for concurrent file conversions
            ...
            <>
              ...
              >
                ...
                <fieldset className="border-0 p-0 m-0 min-w-0">
                  <legend className="block text-sm font-bold text-gray-700">Is Personal Service required instead of a designee or sub service? <span className="text-xs font-normal text-gray-500">(Select all that apply)</span></legend>
                  <div className="mt-2 flex flex-wrap gap-x-6 gap-y-2">
                    <div className="flex items-center"><input id="personal-service-opt" name="service_type_personal" type="checkbox" className="h-4 w-4 text-blue-600 border-gray-300 rounded focus-visible:ring-2 focus-visible:ring-blue-500" /><label htmlFor="personal-service-opt" className="ml-2 block text-sm text-gray-900">Personal Service</label></div>
                    <div className="flex items-center"><input id="sub-service-opt" name="service_type_sub" type="checkbox" className="h-4 w-4 text-blue-600 border-gray-300 rounded focus-visible:ring-2 focus-visible:ring-blue-500" /><label htmlFor="sub-service-opt" className="ml-2 block text-sm text-gray-900">Sub Service at a Residence Allowed</label></div>
                    <div className="flex items-center"><input id="designee-service-opt" name="service_type_designee" type="checkbox" className="h-4 w-4 text-blue-600 border-gray-300 rounded focus-visible:ring-2 focus-visible:ring-blue-500" /><label htmlFor="designee-service-opt" className="ml-2 block text-sm text-gray-900">Authorized Designee</label></div>
                  </div>
                </fieldset>
                ...
                <fieldset className="border-0 p-0 m-0 min-w-0">
                  <legend className="block text-sm font-bold text-gray-700">Service Type</legend>
                  <div className="mt-2 space-y-4">
                      <div className="flex items-start"><div className="flex items-center h-5"><input id="service-standard" name="service_type" type="radio" value="Standard - $60" className="h-4 w-4 text-blue-600 border-gray-300 focus-visible:ring-2 focus-visible:ring-blue-500" /></div><div className="ml-3 text-sm"><label htmlFor="service-standard" className="font-medium text-gray-900">Standard Service <span className="text-xs italic text-gray-600">starting at</span> $60</label><p className="text-gray-500">Ideal for routine document delivery. First Service Attempt Within 5 Business Days (usually sooner)</p></div></div>
                      <div className="flex items-start"><div className="flex items-center h-5"><input id="service-rush" name="service_type" type="radio" value="Rush - $100" className="h-4 w-4 text-blue-600 border-gray-300 focus-visible:ring-2 focus-visible:ring-blue-500" /></div><div className="ml-3 text-sm"><label htmlFor="service-rush" className="font-medium text-gray-900">Rush Service <span className="text-xs italic text-gray-600">starting at</span> $100</label><p className="text-gray-500">For urgent demands that need immediate attention. A JLS Agent Will Attempt Service Within 72 Hours or Sooner based on availability</p></div></div>
                      <div className="flex items-start"><div className="flex items-center h-5"><input id="service-same-day" name="service_type" type="radio" value="Same Day - $150" className="h-4 w-4 text-blue-600 border-gray-300 focus-visible:ring-2 focus-visible:ring-blue-500" /></div><div className="ml-3 text-sm"><label htmlFor="service-same-day" className="font-medium text-gray-900">Same Day Service <span className="text-xs italic text-gray-600">starting at</span> $150</label><p className="text-gray-500">For urgent time-critical matters. A JLS Agent Will Attempt Service Within 24 Hours or Sooner based on availability</p></div></div>
                      <div className="flex items-start"><div className="flex items-center h-5"><input id="service-other" name="service_type" type="radio" value="Other" className="h-4 w-4 text-blue-600 border-gray-300 focus-visible:ring-2 focus-visible:ring-blue-500" /></div><div className="ml-3 text-sm flex-grow"><label htmlFor="service-other" className="font-medium text-gray-900">Other</label><input type="text" name="service_type_other_details" placeholder="Please specify" aria-label="Other service type details" className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"/></div></div>
                  </div>
                </fieldset>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div><label htmlFor="case-number" className="block text-sm font-bold text-gray-700">Case Number <span className="text-red-500">*</span></label><input type="text" id="case-number" name="case_number" required className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"/></div>
                  <div><label htmlFor="deadline" className="block text-sm font-bold text-gray-700">Deadline for Service</label><input type="date" id="deadline" name="service_deadline" className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"/></div>
                  <div><label htmlFor="court-date" className="block text-sm font-bold text-gray-700">Court Date (if any)</label><input type="date" id="court-date" name="court_date" className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"/></div>
                  <div><label htmlFor="court-state" className="block text-sm font-bold text-gray-700">Originating Court - State <span className="text-red-500">*</span></label><input type="text" id="court-state" name="originating_court_state" required className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"/></div>
                  <div><label htmlFor="court-county" className="block text-sm font-bold text-gray-700">County</label><input type="text" id="court-county" name="county" className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"/></div>
                  <div><label htmlFor="court-type" className="block text-sm font-bold text-gray-700">Type of Court <span className="text-xs font-normal text-gray-500">(e.g. Circuit, District, Superior)</span></label><input type="text" id="court-type" name="type_of_court" className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"/></div>
                </div>
                <div>
                  ...
                  <select id="serving-for" name="serving_for_plaintiff_or_defendant" className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500">
                ...
                <div><label htmlFor="defendant" className="block text-sm font-bold text-gray-700">Defendant/ Respondent <span className="text-red-500">*</span></label><input type="text" id="defendant" name="defendant_respondent" required className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"/></div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div><label htmlFor="agent-name" className="block text-sm font-bold text-gray-700">Agent to Be Served / Title <span className="text-xs font-normal text-gray-500">(if serving a business)</span></label><input type="text" id="agent-name" name="agent_to_be_served" className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"/></div>
                  <div><label htmlFor="servee-phone" className="block text-sm font-bold text-gray-700">Servee Phone Number</label><input type="tel" id="servee-phone" name="servee_phone_number" placeholder="(555) 555-5555" className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"/></div>
                  <div><label htmlFor="servee-phone-2" className="block text-sm font-bold text-gray-700">Servee Secondary Phone <span className="text-xs font-normal text-gray-500">(optional)</span></label><input type="tel" id="servee-phone-2" name="servee_phone_secondary" placeholder="(555) 555-5555" className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"/></div>
                  <div><label htmlFor="servee-email" className="block text-sm font-bold text-gray-700">Servee Email <span className="text-xs font-normal text-gray-500">(optional)</span></label><input type="email" id="servee-email" name="servee_email" placeholder="servee@example.com" className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"/></div>
                  <fieldset className="border-0 p-0 m-0 min-w-0">
                    <legend className="block text-sm font-bold text-gray-700">Type of Address</legend>
                    <div className="mt-3 flex items-center gap-6">
                      <div className="flex items-center"><input id="addr-home" name="address_type" type="radio" value="Home" className="h-4 w-4 text-blue-600 border-gray-300 focus-visible:ring-2 focus-visible:ring-blue-500" /><label htmlFor="addr-home" className="ml-2 block text-sm text-gray-900">Home</label></div>
                      <div className="flex items-center"><input id="addr-biz" name="address_type" type="radio" value="Business" className="h-4 w-4 text-blue-600 border-gray-300 focus-visible:ring-2 focus-visible:ring-blue-500" /><label htmlFor="addr-biz" className="ml-2 block text-sm text-gray-900">Business</label></div>
                      <div className="flex items-center"><input id="addr-other" name="address_type" type="radio" value="Other" className="h-4 w-4 text-blue-600 border-gray-300 focus-visible:ring-2 focus-visible:ring-blue-500" /><label htmlFor="addr-other" className="ml-2 block text-sm text-gray-900">Other</label></div>
                    </div>
                  </fieldset>
                </div>
                <div>
                ...
                <fieldset className="border-0 p-0 m-0 min-w-0">
                  ...
                  <div className="mt-2 flex items-center gap-6">
                      <div className="flex items-center"><input id="cooperative-yes" name="is_servee_cooperative" type="radio" value="Yes" className="h-4 w-4 text-blue-600 border-gray-300 focus-visible:ring-2 focus-visible:ring-blue-500" /><label htmlFor="cooperative-yes" className="ml-2 block text-sm text-gray-900">Yes</label></div>
                      <div className="flex items-center"><input id="cooperative-no" name="is_servee_cooperative" type="radio" value="No" className="h-4 w-4 text-blue-600 border-gray-300 focus-visible:ring-2 focus-visible:ring-blue-500" /><label htmlFor="cooperative-no" className="ml-2 block text-sm text-gray-900">No</label></div>
                      <div className="flex items-center"><input id="cooperative-unknown" name="is_servee_cooperative" type="radio" value="Unknown" className="h-4 w-4 text-blue-600 border-gray-300 focus-visible:ring-2 focus-visible:ring-blue-500" /><label htmlFor="cooperative-unknown" className="ml-2 block text-sm text-gray-900">Unknown</label></div>
                  </div>
                </fieldset>
            ...
            <div className="order-1 md:order-1 w-full md:w-auto text-center md:text-left">
              <div className="flex flex-col md:flex-row gap-6 md:gap-8">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <Link href="/about/joseph-iannazzi" className="text-blue-600 hover:text-blue-800 underline font-semibold text-sm">
                    Meet Joseph Iannazzi
                  </Link>
                </div>
                {/* Quick Links Column */}
                <div className="flex flex-col gap-2">
