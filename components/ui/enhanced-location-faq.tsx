...
export default function EnhancedLocationFAQ({ city, county, isNewLocation = false }: LocationFAQProps) {
  ...
  const newLocationQuestions = [
    ...
    },
    {
      ...
      answer: `Process serving rates start at $60 for standard service in ${city}. Visit our pricing page for detailed rates on rush service, same-day delivery, and emergency options.`
    },
    {
