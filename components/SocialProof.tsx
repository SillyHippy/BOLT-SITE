    ...
    <div className="w-full space-y-6">
      ...
      <div className="bg-gradient-to-r from-green-500 to-blue-600 text-white rounded-lg p-6 text-center">
        ...
        <div className="space-y-2">
          <a href="tel:5393676832" className="inline-block bg-white text-blue-600 font-bold py-3 px-8 rounded-lg hover:bg-gray-100 transition-colors focus:ring-2 focus:ring-white focus:outline-none">
