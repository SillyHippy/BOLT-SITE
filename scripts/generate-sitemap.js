...
function generateSitemap() {
  ...
  const additionalUrls = [
    ...
    '/resources/become-process-server-oklahoma',
    '/resources/future-of-process-serving',
    '/resources/skip-trace-checklist',
    '/resources/chain-of-custody-form',
    '/resources/client-intake-form',
    '/resources/gps-service-log',

    // Free download library (30 DOCX + PDF resources)
    '/downloads',

    // Oklahoma process serving hub — calculators & guides
