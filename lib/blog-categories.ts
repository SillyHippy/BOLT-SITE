...
export const BLOG_CATEGORIES: readonly BlogCategory[] = [
  ...
  },
  {
    ...
    posts: [
      ...
      { slug: 'substitute-service-oklahoma', title: 'Substitute Service in Oklahoma', description: 'Residential substitute service under 12 O.S. § 2004(C)(1), document-type limits, abode service, posting, and judicial approval.', date: '2026-04-08' },
