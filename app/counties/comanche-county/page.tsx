...
const COUNTY = getCountyData('comanche-county')!;
      ...
      <div className="container mx-auto px-4 md:px-6 max-w-5xl py-12 space-y-10">
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-blue-700 to-blue-800 text-white">
            ...
            <p className="text-blue-100">Transparent tiered pricing for Comanche County, full rates on our pricing page</p>
          </div>
          <div className="p-8">
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-gray-500 mt-3">Standard, rush, and same-day tiers available in Comanche County. See current rates at /pricing.</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-gradient-to-r from-blue-700 to-blue-800 text-white rounded-2xl shadow-lg">
          <div className="p-8 text-center">
            ...
            <p className="text-xl mb-6 text-blue-100">GPS-tracked, notarized, and court-ready in Comanche County.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
        ...
        <LastUpdated pathname="/counties/comanche-county" label="Last reviewed" className="text-sm text-gray-500 mt-6 mb-2" />
        {/* CountyRelatedLinks */}
        <CountyRelatedLinks countySlug="comanche-county" countyName="Comanche County" />
        <AuthorBio />
