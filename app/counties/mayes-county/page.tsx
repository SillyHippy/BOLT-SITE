...
export const metadata: Metadata = {
  ...
  description: 'Licensed process server throughout Mayes County, Oklahoma. Serving Pryor. $60 standard, same-day available.',
  ...
  openGraph: {
    title: 'Process Server Mayes County OK | Just Legal Solutions',
  ...
  twitter: {
    ...
    title: 'Process Server Mayes County OK',
