      ...
      <section className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 text-white py-16 md:py-24">
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-3xl leading-relaxed">
            Licensed process server in Cimarron County, Oklahoma. Serving Boise City, Keyes, and all surrounding communities.
          </p>
      ...
      <div className="container mx-auto px-4 md:px-6 max-w-5xl py-12 space-y-10">
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-blue-700 to-blue-800 text-white">
            ...
            <p className="text-blue-100">Flat rates — no hidden mileage fees in Cimarron County</p>
          </div>
          <div className="p-8">
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-gray-500 mt-3">All rates are flat — no hidden mileage fees in Cimarron County.</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-gradient-to-r from-blue-700 to-blue-800 text-white rounded-2xl shadow-lg">
          <div className="p-8 text-center">
            ...
            <p className="text-xl mb-6 text-blue-100">GPS-tracked, notarized, court-ready — in Cimarron County.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
