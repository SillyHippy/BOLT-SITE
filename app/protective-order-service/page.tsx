...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: 'website',
    locale: 'en_US',
    images: [{ url: 'https://justlegalsolutions.org/image-pack/images/image-061-protective-order-service-hero.webp', width: 1200, height: 630, alt: 'Protective order service in Oklahoma' }],
  },
  twitter: {
