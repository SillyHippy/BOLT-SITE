...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: 'en_US',
    type: 'website',
    images: [{ url: 'https://justlegalsolutions.org/image-pack/images/image-047-oklahoma-process-server-pricing-og.webp', width: 1200, height: 630, alt: 'Process serving service tiers comparison' }],
  },
  twitter: {
