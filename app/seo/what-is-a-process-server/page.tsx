...
export default function WhatIsAProcessServerPage() {
  return (
    <>
      ...
      />
      <Navbar />
      <main className="min-h-screen bg-white text-gray-900 font-sans pt-14">
          ...
          <article className="max-w-none mx-auto prose prose-lg">
            ...
            <section className="mb-12" id="faq">
              ...
              <p className="text-center text-gray-600 mb-8 max-w-3xl mx-auto">
                Get instant answers to the most common questions about process serving in Oklahoma. Click any question to expand the detailed answer. <Link href="/oklahoma-process-server-faq" className="text-blue-600 hover:underline font-medium">View our complete FAQ page →</Link>
              </p>
