          ...
          <div className="bg-gradient-to-r from-indigo-50 to-blue-50 border border-indigo-200 rounded-lg p-8 mb-8">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white rounded-lg p-6 border border-indigo-300">
                ...
                <p className="text-indigo-800 font-semibold">Starting at $15/hour</p>
              </div>
              <div className="bg-white rounded-lg p-6 border border-indigo-300">
                ...
                <p className="text-indigo-800 font-semibold">Starting at $25/hour</p>
              </div>
              <div className="bg-white rounded-lg p-6 border border-indigo-300">
                ...
                <p className="text-indigo-800 font-semibold">Starting at $35/hour</p>
              </div>
            </div>
          </div>
