...
export const metadata: Metadata = {
  ...
  description: 'Oklahoma chain-of-custody guide: document every handoff from firm intake through licensed service, 12 O.S. § 2004(G) affidavits, and § 2901 authentication.',
  ...
  other: {
    ...
    'ai-summary': 'Oklahoma chain of custody from firm intake through licensed service—12 O.S. § 2004(G) affidavits, § 2901 authentication, GPS and photo proof, spoliation risks, and retention under CLEET standards.',
    'ai-key-facts': 'Chain of custody logs every handoff from creation through court filing; Affidavits under 12 O.S. § 2004(G) prove service but do not replace the full chain; 12 O.S. § 2901 ties admissibility to documented integrity; GPS and timestamped photos carry weight under 12A O.S. § 15-101; Licensed servers should retain records at least three years per CLEET guidance',
  },
};
  ...
  return (
    <>
      <UnifiedSchema
        ...
        pageDescription="Oklahoma chain-of-custody guide: document every handoff from firm intake through licensed service, 12 O.S. § 2004(G) affidavits, and § 2901 authentication."
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <div className="bg-green-50 border-2 border-green-300 p-4 rounded-lg mb-6 max-w-3xl mx-auto text-left">
            ...
            <p className="text-gray-800">
              Chain of custody is the chronological record of who handled a legal document, when, and how—from your office through licensed service to court filing. In Oklahoma, an undocumented gap can exclude evidence under <strong>12 O.S. § 2901</strong>, invite service challenges under <strong>12 O.S. § 2004(G)</strong>, or trigger spoliation sanctions. Intake logs, transfer receipts, GPS-verified attempts, time-stamped photos, and prompt affidavits keep the chain intact.
            </p>
