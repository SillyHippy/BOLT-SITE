...
export const metadata: Metadata = {
  ...
  description: 'Learn how to apostille a document in Oklahoma. Step-by-step guide covering processing times, $25 fee, common mistakes, and which documents qualify. Call (539) 367-6832.',
  ...
  openGraph: {
    ...
    locale: 'en_US',
    type: 'article',
    images: [{ url: 'https://justlegalsolutions.org/og-image.webp', width: 1200, height: 630, alt: 'How to Apostille a Document in Oklahoma' }],
  },
