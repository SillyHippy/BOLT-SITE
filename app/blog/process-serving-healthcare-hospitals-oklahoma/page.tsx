...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: 'en_US',
    type: 'article',
    images: [{ url: 'https://justlegalsolutions.org/image-pack/images/image-043-blog-hero.webp', width: 1200, height: 630, alt: 'Process Serving for Oklahoma Healthcare & Hospital Systems' }],
  },
  twitter: {
    ...
    <>
      ...
      <section className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 pt-28 pb-16 overflow-hidden">
        ...
        <div className="bg-green-50 border-2 border-green-300 p-4 rounded-lg mb-6">
          ...
          <p className="text-gray-800">Serving legal documents at Oklahoma healthcare facilities requires <strong>compliance with HIPAA, facility security policies, and 12 O.S. § 2004</strong>. Subpoenas for medical records must be served on the custodian of records, not the patient. Just Legal Solutions handles hospital and clinic serves statewide — <strong>(539) 367-6832</strong>.</p>
        </div>
