...
export const metadata: Metadata = {
  title: 'Process Serving for Oklahoma Healthcare & Hospital Systems (2026) | Just Legal Solutions',
  ...
  openGraph: {
    ...
    locale: 'en_US',
    type: 'article',
    images: [{ url: 'https://justlegalsolutions.org/og-image.png', width: 1200, height: 630, alt: 'Process Serving for Oklahoma Healthcare & Hospital Systems' }],
  },
