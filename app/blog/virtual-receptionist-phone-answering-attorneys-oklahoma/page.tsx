    ...
    <>
      ...
      <div className="bg-gray-50 min-h-screen">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8 relative z-10 pb-16">
          ...
          <p>
            At Just Legal Solutions, we provide comprehensive <Link href="/services" className="text-blue-600 hover:underline">virtual assistant and legal support services</Link> designed specifically for Oklahoma attorneys. Our team understands the unique demands of legal practice in this state, and we work with firms of every size — from solo practitioners in rural counties to busy multi-attorney firms in Tulsa and Oklahoma City.
          </p>
          </article>
