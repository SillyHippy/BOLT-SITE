    ...
    <>
      ...
      <section className="relative bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-white py-24 sm:py-32 overflow-hidden">
        ...
        <div className="bg-green-50 border-2 border-green-300 p-4 rounded-lg mb-6">
          ...
          <p className="text-gray-800">Document automation streamlines legal workflows by <strong>reducing manual data entry, accelerating filing timelines, and minimizing errors</strong>. Just Legal Solutions uses automated systems alongside licensed process serving under <strong>12 O.S. § 158.1</strong> across all <strong>77 Oklahoma counties</strong>.</p>
        </div>
      ...
      <div className="bg-gray-50 min-h-screen">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8 relative z-10 pb-16">
          ...
          <p>
            Think about your current workflow. How many times this month have you drafted essentially the same document with different names, dates, and dollar amounts? Each of those represents billable hours that automation can reclaim. The key is identifying your 5 to 10 most frequently drafted documents and starting there. Just Legal Solutions helps firms implement automated workflows that identify and optimize these high-volume document types.
          </p>
          ...
          <p>
            Consider automation tools that generate compliant PDFs automatically. The right document automation platform can apply the correct margins, insert signature blocks, and generate text-searchable PDFs without manual intervention. Client portals complement e-filing by providing secure document access for clients who need to review or sign documents before submission.
          </p>
          ...
          <p>
            At Just Legal Solutions, we have invested heavily in automation for our own operations. Our affidavit generation system produces complete, court-ready documents in under 15 minutes. Our AI-powered routing system achieves 95% first-attempt success rates by analyzing address data, historical delivery patterns, and real-time traffic conditions. Electronic proof of service and digital signatures are now standard across our operations, and our clients receive automated status updates at every milestone. If you are a legal support provider wondering whether automation is worth the investment, the answer is a definitive yes.
          </p>
          ...
          <p>
            The Oklahoma Bar Association's "Law Firm Automation Manifesto," published in February 2025, provides additional guidance and is worth a read for any firm considering automation. It includes practical worksheets for identifying automation opportunities and templates for building your business case. Virtual assistants can also support your document preparation workflow by handling intake, formatting, and quality control, freeing your attorneys to focus on substantive legal work.
          </p>
          <p>
