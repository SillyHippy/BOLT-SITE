...
export const metadata: Metadata = {
  ...
  other: {
    ...
    'article:modified_time': '2026-09-15',
      ...
      <div className="bg-gray-50 min-h-screen">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8 relative z-10 pb-16">
          <article className="prose prose-lg prose-blue max-w-none bg-white p-8 md:p-12 rounded-2xl shadow-lg border border-gray-100">
            ...
            which do not — will save you time, money, and headaches. At Just Legal Solutions, 
          ...
          <p>
            Notarization is especially recommended for high-value patents, inventor-to-company transfers, assignments involving foreign parties, any assignment that might later be used as evidence in litigation, university tech transfer assignments, and assignments made by elderly or ill inventors whose testimony may not be available in the future. Just Legal Solutions regularly notarizes patent assignments for Oklahoma inventors, startups, and university tech transfer offices across all 77 counties. We understand the evidentiary stakes and handle these documents with the precision they demand.
          </p>
          ...
          <p>
            There is one important caveat: while U.S. filings do not require notarization, foreign trademark applicants may need notarized powers of attorney depending on the destination country&apos;s requirements. A Canadian company filing in Canada, for example, may need a notarized Canadian power of attorney. These requirements are country-specific and have nothing to do with the USPTO. If you are filing trademarks abroad, our guide to apostille services can help you navigate those requirements.
          </p>
