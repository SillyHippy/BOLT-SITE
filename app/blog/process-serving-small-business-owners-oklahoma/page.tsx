...
export const metadata: Metadata = {
  ...
  description: 'Guide for Oklahoma small business owners on process serving. When to sue, breach of contract, mechanic\'s liens, and protecting your business.',
  ...
  openGraph: {
    ...
    locale: 'en_US',
    type: 'article',
    images: [{ url: 'https://justlegalsolutions.org/image-pack/images/image-043-blog-hero.webp', width: 1200, height: 630, alt: 'Process Serving for Oklahoma Small Business Owners' }],
  },
  twitter: {
    ...
    <>
      ...
      <section className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 pt-28 pb-16 overflow-hidden">
        ...
        <div className="bg-green-50 border-2 border-green-300 p-4 rounded-lg mb-6">
          ...
          <p className="text-gray-800">Oklahoma small businesses can be served by <strong>delivering process to the owner, manager, or registered agent</strong> per 12 O.S. § 2004. LLCs and corporations require service on the registered agent filed with the Secretary of State. Just Legal Solutions serves Oklahoma businesses in all <strong>77 counties</strong> — <strong>(539) 367-6832</strong>.</p>
        </div>
