      ...
      <div className="bg-gray-50 min-h-screen py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav aria-label="Breadcrumb" className="flex items-center space-x-2 text-sm text-gray-500 mb-8">
            ...
            <ChevronRight className="w-4 h-4" />
            <span className="text-gray-900 font-medium">How to Serve a Subpoena in Oklahoma</span>
          </nav>
          ...
          <section className="mt-12 mb-8 bg-white rounded-xl shadow-sm p-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <Link href="/process-serving-for-insurance-companies" className="block p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
                <span className="font-semibold text-blue-800">Process Serving for Insurance Companies</span>
                <p className="text-sm text-blue-700 mt-1">Specialized subpoena and process serving for insurance companies and medical record requests.</p>
              </Link>
              <Link href="/affidavit-of-service" className="block p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
                ...
                <p className="text-sm text-blue-700 mt-1">Why a proper affidavit of service is essential to subpoena enforcement in Oklahoma courts.</p>
              </Link>
            </div>
          </section>
