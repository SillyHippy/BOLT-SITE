    ...
    <>
      ...
      <div className="bg-gray-50 min-h-screen">
        ...
        <div className="bg-green-50 border-2 border-green-300 p-4 rounded-lg mb-6">
          ...
          <p className="text-gray-800">Subpoenas in Oklahoma must be served by <strong>personal delivery</strong> per 12 O.S. § 2004 by a licensed process server. Costs range <strong>$35–$265</strong> — call <strong>(539) 367-6832</strong> for service across all <strong>77 counties</strong>.</p>
        </div>
