    ...
    <>
      ...
      <div className="bg-gray-50 min-h-screen">
        ...
        <div className="bg-green-50 border-2 border-green-300 p-4 rounded-lg mb-6">
          ...
          <p className="text-gray-800">File a protective order petition at your local Oklahoma courthouse — <strong>emergency orders can be issued immediately</strong>. Just Legal Solutions provides service of protective orders across all <strong>77 counties</strong> — call <strong>(539) 367-6832</strong>.</p>
        </div>
