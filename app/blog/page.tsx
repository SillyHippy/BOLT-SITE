      ...
      <div className="bg-gradient-to-b from-slate-50 to-white min-h-screen">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20">
          ...
          <section className="mb-16 rounded-2xl border border-slate-200 bg-white p-6 md:p-8 shadow-sm">
            <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-2">Oklahoma Service Hubs</h2>
            <p className="text-gray-600 text-sm mb-5">
              Start with our main service pages for process serving, mobile notary, and legal document delivery — then browse articles by topic below.
            </p>
            <div className="flex flex-wrap gap-3">
              <Link href="/process-serving" className="inline-flex items-center gap-2 rounded-lg bg-blue-900 px-4 py-2.5 text-sm font-semibold text-white hover:bg-blue-800 transition">
                Process Serving
              </Link>
              <Link href="/mobile-notary" className="inline-flex items-center gap-2 rounded-lg bg-teal-700 px-4 py-2.5 text-sm font-semibold text-white hover:bg-teal-600 transition">
                Mobile Notary
              </Link>
              <Link href="/courier-services" className="inline-flex items-center gap-2 rounded-lg bg-indigo-700 px-4 py-2.5 text-sm font-semibold text-white hover:bg-indigo-600 transition">
                Legal Document Courier
              </Link>
              <Link href="/oklahoma-process-serving-hub" className="inline-flex items-center gap-2 rounded-lg border border-slate-300 bg-slate-50 px-4 py-2.5 text-sm font-semibold text-slate-800 hover:bg-slate-100 transition">
                Calculators &amp; Guides Hub
              </Link>
            </div>
          </section>
