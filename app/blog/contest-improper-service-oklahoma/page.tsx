    ...
    <>
      ...
      <section className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 pt-28 pb-16 overflow-hidden">
        ...
        <div className="bg-green-50 border-2 border-green-300 p-4 rounded-lg mb-6">
          ...
          <p className="text-gray-800">You can contest improper service in Oklahoma by filing a <strong>motion to quash</strong> if the server violated <strong>12 O.S. § 2004</strong> rules (wrong person, wrong method, or no proof). Licensed process servers under <strong>12 O.S. § 158.1</strong> ensure proper service — Just Legal Solutions covers all <strong>77 counties</strong>.</p>
        </div>
