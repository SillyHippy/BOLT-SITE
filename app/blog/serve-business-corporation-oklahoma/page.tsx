    ...
    <>
      ...
      <section className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 pt-28 pb-16 overflow-hidden">
        ...
        <div className="bg-green-50 border-2 border-green-300 p-4 rounded-lg mb-6">
          ...
          <p className="text-gray-800">To serve an Oklahoma business or corporation, deliver process to the <strong>registered agent on file with the Oklahoma Secretary of State</strong> under 12 O.S. § 2004. If the registered agent cannot be found, alternative service may be available by court order. Just Legal Solutions serves Oklahoma businesses statewide — <strong>(539) 367-6832</strong>.</p>
        </div>
