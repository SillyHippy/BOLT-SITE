...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: 'en_US',
    type: 'article',
    images: [{ url: 'https://justlegalsolutions.org/image-pack/images/image-043-blog-hero.webp', width: 1200, height: 630, alt: 'Oklahoma Default Judgment: What Happens When Someone Doesn\'t Respond' }],
  },
  twitter: {
    ...
    <>
      ...
      <div className="bg-gray-50 min-h-screen">
        ...
        <div className="bg-green-50 border-2 border-green-300 p-4 rounded-lg mb-6">
          ...
          <p className="text-gray-800">A <strong>default judgment</strong> in Oklahoma is granted when a defendant fails to respond after proper service. The plaintiff must file a motion and prove service was completed per <strong>12 O.S. § 2004</strong>. Call <strong>(539) 367-6832</strong> for service across all <strong>77 counties</strong>.</p>
        </div>
