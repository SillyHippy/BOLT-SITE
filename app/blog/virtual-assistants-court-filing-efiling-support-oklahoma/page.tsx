    ...
    <>
      ...
      <div className="bg-gray-50 min-h-screen">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8 relative z-10 pb-16">
          ...
          <p>
            A virtual assistant who understands this divide is invaluable. They know which counties accept electronic filings and which require physical delivery. They will not waste your time attempting portal registrations in KellPro counties. Instead, they will route those documents for physical filing through a courier or in-person delivery service. At Just Legal Solutions, we bridge this gap by offering <Link href="/services/courier" className="text-blue-600 hover:underline">courier services</Link> that deliver documents directly to courthouse clerks in the 64 counties where e-filing is not yet available.
          </p>
          ...
          <p>
            OSCN efiling help is one of the most requested services we provide at Just Legal Solutions. Our <Link href="/services/virtual-assistant-services" className="text-blue-600 hover:underline">VAs are trained specifically on Oklahoma's OSCN e-filing portal requirements</Link>. They handle the entire submission process: registering on the portal, selecting the correct case type from the available options (CJ, CS, CV, FB, FD, FMI, FP, FR, PB, PMI, PT, SC, SD, TL, and WIL), uploading properly formatted documents, paying fees by credit card or ACH transfer, and tracking submission status until confirmation is received.
          </p>
          <p>
          ...
          <p>
            There is another critical limitation: initial service of summons must ALWAYS be done in person. Never electronically. E-service is limited to subsequent filings only — motions, responses, discovery, and other documents filed after the case is already open. The original summons and petition must be served physically by a licensed process server or other authorized person. You can learn more about the difference between electronic filing and electronic service in Oklahoma on our <Link href="/learn/electronic-filing-service" className="text-blue-600 hover:underline">educational resource page</Link>. For initial service of summons that must be completed in person, our <Link href="/services/process-serving" className="text-blue-600 hover:underline">licensed process servers handle personal service statewide</Link> across all 77 Oklahoma counties.
          </p>
          ...
          <p>
            No national VA provider can offer this combination. They can handle electronic filing remotely, but they cannot physically deliver documents to a courthouse in Ellis County or Adair County. Our <Link href="/services/courier" className="text-blue-600 hover:underline">courier services</Link> cover all 64 non-OCIS counties for physical document filing, giving you one point of contact for every county in Oklahoma. Whether you are a solo practitioner or a mid-sized firm, this hybrid model scales to your caseload without hiring commitments, long-term contracts, or the frustration of managing multiple vendors.
          </p>
