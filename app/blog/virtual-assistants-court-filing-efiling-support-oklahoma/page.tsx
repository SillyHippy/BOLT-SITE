...
export const metadata: Metadata = {
  ...
  other: {
    ...
    'ai-summary': 'How Oklahoma virtual assistants handle OSCN e-filing in 13 pilot counties and physical filing in 64 KellPro counties, reducing admin time and rejected filings.',
    'ai-key-facts': 'OSCN e-filing in 13 of 77 counties; e-filing ≠ e-service under 12 O.S. § 2004.5; VAs save 50–70% vs in-house staff; 99% first-time acceptance with support',
  },
};
    ...
    <>
      ...
      <section className="relative bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-white py-24 sm:py-32 overflow-hidden">
        ...
        <div className="bg-green-50 border-2 border-green-300 p-4 rounded-lg mb-6">
          ...
          <p className="text-gray-800">Oklahoma eFiling is done through the <strong>OSCN (Oklahoma State Courts Network)</strong> portal. Virtual assistants can prepare, upload, and track filings but cannot give legal advice. Just Legal Solutions offers trained eFiling VA support for attorneys statewide — <strong>(539) 367-6832</strong>.</p>
        </div>
