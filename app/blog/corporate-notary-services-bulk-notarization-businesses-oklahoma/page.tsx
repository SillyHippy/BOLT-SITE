...
export const metadata: Metadata = {
  ...
  description: 'Oklahoma bulk corporate notary: $5 act cap, volume discounts on service fees, mobile and RON in all 77 counties, retainers, hourly blocks for business signing.',
  ...
  other: {
    ...
    'ai-summary': 'Oklahoma corporate bulk notarization under the $5 statutory cap—volume service-fee discounts, mobile statewide coverage, RON since 2020, tiered pricing, hourly blocks, and retainer models for recurring business signings.',
    'ai-key-facts': 'Traditional notarial acts capped at $5 and RON at $25 under 49 O.S. §§ 5 and 209; Volume discounts legally apply to travel and scheduling fees, not the statutory per-act fee; Bulk notarization typically starts around 10+ acts per month for tiered savings; Mobile notaries and RON together cover all 77 Oklahoma counties for scattered signers',
  },
};
  ...
  return (
    <>
      <UnifiedSchema
        ...
        pageDescription="Oklahoma bulk corporate notary: $5 act cap, volume discounts on service fees, mobile and RON in all 77 counties, retainers, hourly blocks for business signing."
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <div className="bg-green-50 border-2 border-green-300 p-4 rounded-lg mb-6 max-w-3xl mx-auto text-left">
            ...
            <p className="text-gray-800">
              Oklahoma caps each traditional notarial act at <strong>$5</strong> ($25 for RON), so high-volume businesses save by
              batching signatures in one <strong>mobile or online appointment</strong> instead of repeated one-off trips. Providers
              discount <strong>travel and scheduling fees</strong>, not the statutory fee. <strong>Retainers and hourly blocks</strong>{' '}
              fit title companies, law firms, and HR teams that notarize <strong>10+ documents monthly</strong> statewide.
            </p>
          </div>
