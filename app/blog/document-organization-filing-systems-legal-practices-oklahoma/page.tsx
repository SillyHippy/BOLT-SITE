    ...
    <>
      ...
      <section className="relative bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-white py-24 sm:py-32 overflow-hidden">
        ...
        <div className="bg-green-50 border-2 border-green-300 p-4 rounded-lg mb-6">
          ...
          <p className="text-gray-800">Effective document organization and filing systems help Oklahoma legal practices <strong>reduce retrieval time, ensure compliance, and prevent lost evidence</strong>. Just Legal Solutions integrates organized filing with licensed process serving under <strong>12 O.S. § 158.1</strong> across all <strong>77 counties</strong>.</p>
        </div>
