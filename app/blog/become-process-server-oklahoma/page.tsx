...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: 'en_US',
    type: 'article',
    images: [{ url: 'https://justlegalsolutions.org/image-pack/images/image-099-blog-become-process-server-oklahoma-card.png', width: 1200, height: 630, alt: 'How to Become a Process Server in Oklahoma' }],
  },
    ...
    <>
      <UnifiedSchema
        ...
        articleDetails={{
          ...
          image: "https://justlegalsolutions.org/image-pack/images/image-099-blog-become-process-server-oklahoma-card.png"
        }}
