...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: 'website',
    images: [{ url: 'https://justlegalsolutions.org/image-pack/images/image-046-oklahoma-process-server-laws-hero.png', width: 1200, height: 630, alt: 'Just Legal Solutions - Professional Process Serving in Oklahoma' }],
  },
  alternates: {
