...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: 'en_US',
    type: 'website',
    images: [{ url: 'https://justlegalsolutions.org/image-pack/images/image-073-process-serving-for-debt-collection-card.webp', width: 1200, height: 630, alt: 'Process Serving for Debt Collection Agencies Oklahoma' }],
  },
  twitter: {
    ...
    images: ['https://justlegalsolutions.org/image-pack/images/image-073-process-serving-for-debt-collection-card.webp'],
  },
