...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: 'website',
    locale: 'en_US',
    images: [{ url: 'https://justlegalsolutions.org/image-pack/images/image-045-oklahoma-process-server-faq-og.webp', width: 1200, height: 630, alt: 'Tulsa Process Server FAQ 2026' }],
  },
  twitter: {
