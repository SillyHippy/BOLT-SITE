...
export const metadata: Metadata = {
  ...
  description: 'Calculate your Oklahoma process server cost instantly. Enter your county, service type, and add-ons to get an estimated price range. Current standard service from $80. Call (539) 367-6832.',
  ...
  openGraph: {
    ...
    description: 'Estimate your Oklahoma process serving cost instantly. Current standard service from $80. All 77 counties.',
