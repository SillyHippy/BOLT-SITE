...
export const metadata: Metadata = {
  ...
  description: 'Calculate your Oklahoma process server cost instantly. Enter your county, service type, and add-ons to get an estimated price range. Standard from $60. Call (539) 367-6832.',
