...
const faqs = [
    ...
    { question: "Is weekend service more expensive?", answer: "Weekend service may carry a surcharge, typically $25-$50 extra, depending on the service provider. At Just Legal Solutions, standard service is $60 and includes attempts at varied times (including evenings and weekends) as needed. Dedicated weekend-only or holiday service requests may include a surcharge. Same-day rush ($150) and emergency ($265) pricing applies regardless of day." },
