...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        images: [{ url: 'https://justlegalsolutions.org/og-image.webp', width: 1200, height: 630, alt: 'Process Serving Timeline Guide' }],
    },
...
export default function HowLongPage() {
    return (
        <>
            ...
            <UnifiedSchema pageType="article" title="How Long Does Process Serving Take?" description="Timeline guide: 2 hours to 6 weeks depending on method. Full comparison." url="https://justlegalsolutions.org/how-long-does-process-serving-take" image="https://justlegalsolutions.org/og-image.webp" keywords={['how long process serving takes', 'process serving timeline', 'fast paper serving']} reviewCount={156} services={['Standard Service', 'Same-Day Rush', '2-Hour Emergency']} breadcrumbs={[{ name: 'Home', url: '/' }, { name: 'How Long Does Process Serving Take?', url: '/how-long-does-process-serving-take' }]} />
        </>
    );
}
