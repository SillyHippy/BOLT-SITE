...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: 'en_US',
    type: 'website',
    images: [{ url: 'https://justlegalsolutions.org/image-pack/images/image-074-process-serving-for-insurance-companies-card.webp', width: 1200, height: 630, alt: 'Process Serving for Insurance Companies Oklahoma' }],
  },
  twitter: {
    ...
    images: ['https://justlegalsolutions.org/image-pack/images/image-074-process-serving-for-insurance-companies-card.webp'],
  },
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-8">
              ...
              <div>
                ...
                <ul className="space-y-3">
                  ...
                  <li><a href="https://www.napps.org" target="_blank" rel="noopener noreferrer nofollow" className="text-blue-600 hover:text-blue-800 underline text-sm">NAPPS — National Association of Professional Process Servers</a></li>
