...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: 'en_US',
    type: 'website',
    images: [{ url: 'https://justlegalsolutions.org/image-pack/images/image-074-process-serving-for-insurance-companies-card.png', width: 1200, height: 630, alt: 'Process Serving for Insurance Companies Oklahoma' }],
  },
  twitter: {
    ...
    images: ['https://justlegalsolutions.org/image-pack/images/image-074-process-serving-for-insurance-companies-card.png'],
  },
