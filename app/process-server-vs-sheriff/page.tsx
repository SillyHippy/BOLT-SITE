...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: 'website',
    locale: 'en_US',
    images: [{ url: 'https://justlegalsolutions.org/image-pack/images/image-070-process-server-vs-sheriff-og.webp', width: 1200, height: 630, alt: 'Process Server vs Sheriff Oklahoma comparison' }],
  },
  twitter: {
