...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      'How the landmark McGirt v. Oklahoma Supreme Court decision affects process serving on tribal land. Jurisdictional changes, tribal coordination, and practical guidance.',
    url: 'https://justlegalsolutions.org/guides/mcgirt-v-oklahoma',
    type: 'article',
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://justlegalsolutions.org/guides/mcgirt-v-oklahoma',
  },
};
      ...
      <main className="pt-20 pb-16">
        <div className="max-w-4xl mx-auto px-4">
          ...
          >
            ...
            <span>/</span>
            <span className="text-gray-900">McGirt v. Oklahoma</span>
          </nav>
