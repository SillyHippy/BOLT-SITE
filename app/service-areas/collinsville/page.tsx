...
export const metadata: Metadata = {
  title: 'Process Server Collinsville, OK | Licensed Legal Document Service',
  description: 'Licensed process server in Collinsville, Oklahoma. GPS-tracked and court-ready. Call (539) 367-6832.',
  keywords: 'process server Collinsville OK, serve papers Collinsville Oklahoma, legal document service Collinsville, subpoena service Collinsville',
...
const pageFAQs: { question: string; answer: string }[] = [
  ...
  { question: 'Is same-day process service available?', answer: 'Yes. Our same-day service can cover Collinsville and all surrounding areas. Call before noon for best scheduling.' },
...
const employers: { name: string; address: string; industry: string; notes: string }[] = [
  { name: 'Collinsville Public Schools', address: '', industry: 'Education', notes: 'Primary local employer.' },
  { name: 'City of Collinsville', address: '', industry: 'Government', notes: 'Municipal services.' },
      ...
      <section className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 text-white py-16 md:py-24">
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          ...
          <div className="flex flex-wrap gap-4 mb-4 text-blue-200 text-sm">
            <span className="flex items-center gap-1"><Users className="h-4 w-4" /> Population: 8,878</span>
            
            <span>🚗 105 min from OKC</span>
            <span>🚗 25 min from Tulsa</span>
          </div>
          <p className="text-lg text-blue-100 mb-4 italic">A rapidly growing bedroom community north of Tulsa in Rogers and Tulsa counties..</p>
          <p className="text-xl text-blue-100 mb-8 max-w-3xl leading-relaxed">
            Licensed process server in Collinsville, Oklahoma. GPS-tracked and court-ready. Call (539) 367-6832.
          </p>
      ...
      <div className="container mx-auto px-4 md:px-6 max-w-5xl py-12 space-y-10">
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-slate-700 to-slate-800 text-white">
            ...
            <p className="text-slate-300">Collinsville, Oklahoma</p>
          </div>
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          ...
          <div className="p-8 grid md:grid-cols-2 gap-6">
            <div className="bg-gray-50 p-5 rounded-xl">
              ...
              <p className="text-gray-700 text-sm">Main St commercial strip and municipal offices.</p>
            </div>
            <div className="bg-gray-50 p-5 rounded-xl">
              <h3 className="font-semibold text-gray-900 mb-2">South Collinsville</h3>
              <p className="text-gray-700 text-sm">Established neighborhoods near the high school.</p>
            </div>
            <div className="bg-gray-50 p-5 rounded-xl">
              <h3 className="font-semibold text-gray-900 mb-2">North Collinsville</h3>
              <p className="text-gray-700 text-sm">Newer subdivisions and rural residential development.</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-emerald-600 to-emerald-700 text-white">
            ...
            <p className="text-emerald-100">Serving businesses and employees in Collinsville</p>
          </div>
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-teal-600 to-teal-700 text-white">
            <h2 className="text-2xl font-bold mb-1">Collinsville FAQ</h2>
