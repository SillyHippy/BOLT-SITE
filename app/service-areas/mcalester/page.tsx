...
export const metadata: Metadata = {
  title: 'Process Server McAlester, OK | Pittsburg County Seat',
  description: 'Licensed process server in McAlester, Oklahoma. Serving Pittsburg County District Court, Oklahoma State Penitentiary, and surrounding areas.',
  keywords: 'process server Mcalester OK, serve papers Mcalester Oklahoma, legal document service Mcalester, subpoena service Mcalester',
  authors: [{ name: 'Just Legal Solutions', url: 'https://justlegalsolutions.org' }],
  robots: { index: true, follow: true },
  openGraph: {
    title: 'Process Server McAlester, OK | Pittsburg County Seat',
    description: 'Licensed process server in McAlester, Oklahoma. Serving Pittsburg County District Court, Oklahoma State Penitentiary, and surrounding areas.',
    url: 'https://justlegalsolutions.org/service-areas/mcalester',
    siteName: 'Just Legal Solutions',
    locale: 'en_US',
    type: 'website',
  },
  alternates: {
    canonical: 'https://justlegalsolutions.org/service-areas/mcalester',
  },
};

const pageFAQs: { question: string; answer: string }[] = [
  { question: 'Do all Pittsburg County cases file at the Pittsburg County Courthouse?', answer: 'Yes. All district-court civil, family, and felony cases for Pittsburg County residents file at the Pittsburg County Courthouse. Municipal cases are handled separately at the local municipal court.' },
  { question: 'Is same-day process service available?', answer: 'Yes. Our same-day service can cover Mcalester and all surrounding areas. Call before noon for best scheduling.' },
...
const employers: { name: string; address: string; industry: string; notes: string }[] = [
  { name: 'Oklahoma State Penitentiary', address: '', industry: 'Corrections', notes: 'Secure state facility.' },
  { name: 'McAlester Army Ammunition Plant', address: '', industry: 'Military/Defense', notes: 'Secure federal ammunition facility.' },
  { name: 'McAlester Regional Health Center', address: '', industry: 'Healthcare', notes: 'Regional hospital.' },
  { name: 'McAlester Public Schools', address: '', industry: 'Education', notes: 'Local district.' },
  { name: 'City of McAlester', address: '', industry: 'Government', notes: 'Municipal services.' },
  { name: 'Walmart Supercenter', address: '', industry: 'Retail', notes: 'Primary retail.' },
];

export default function McalesterProcessServerPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 text-white py-16 md:py-24">
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          <nav className="text-sm mb-6 text-blue-200" aria-label="Breadcrumb">
            ...
            <span className="mx-2">/</span>
            <span className="text-white font-medium">Mcalester</span>
          </nav>
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold leading-tight mb-5">
            Process Server<br className="hidden md:block" /> Mcalester, Oklahoma
          </h1>
          <div className="flex flex-wrap gap-4 mb-4 text-blue-200 text-sm">
            <span className="flex items-center gap-1"><Users className="h-4 w-4" /> Population: 18,111</span>
            
            <span>🚗 110 min from OKC</span>
            <span>🚗 85 min from Tulsa</span>
          </div>
          <p className="text-lg text-blue-100 mb-4 italic">Home to the Oklahoma State Penitentiary and McAlester Army Ammunition Plant..</p>
          <p className="text-xl text-blue-100 mb-8 max-w-3xl leading-relaxed">
            Licensed process server in McAlester, Oklahoma. Serving Pittsburg County District Court, Oklahoma State Penitentiary, and surrounding areas.
          </p>
      ...
      <div className="container mx-auto px-4 md:px-6 max-w-5xl py-12 space-y-10">
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-slate-700 to-slate-800 text-white">
            ...
            <p className="text-slate-300">Mcalester, Oklahoma</p>
          </div>
          <div className="p-8 space-y-4">
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-5">
              <p className="font-semibold text-lg text-gray-900">Pittsburg County Courthouse</p>
              <p className="text-gray-700">115 E Carl Albert Pkwy, McAlester, OK 74501</p>
              <p className="text-gray-600 text-sm mt-1">📞 (918) 423-4859</p>
            ...
            <div className="bg-orange-50 border border-orange-200 rounded-xl p-4">
              ...
              <p className="text-orange-700 text-sm">McAlester Army Ammunition Plant is a secure federal facility.</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-indigo-600 to-indigo-700 text-white">
            <h2 className="text-2xl font-bold mb-1">Where We Serve Papers in Mcalester</h2>
            <p className="text-indigo-100">Local coverage across Pittsburg County</p>
          </div>
          <div className="p-8 grid md:grid-cols-2 gap-6">
            <div className="bg-gray-50 p-5 rounded-xl">
              <h3 className="font-semibold text-gray-900 mb-2">Downtown McAlester</h3>
              <p className="text-gray-700 text-sm">Courthouse district and historic commercial buildings.</p>
            </div>
            <div className="bg-gray-50 p-5 rounded-xl">
              <h3 className="font-semibold text-gray-900 mb-2">South McAlester</h3>
              <p className="text-gray-700 text-sm">Oklahoma State Penitentiary and secure government facilities.</p>
            </div>
            <div className="bg-gray-50 p-5 rounded-xl">
              <h3 className="font-semibold text-gray-900 mb-2">McAlester AAP Area</h3>
              <p className="text-gray-700 text-sm">Federal installation; no unauthorized access.</p>
            </div>
            <div className="bg-gray-50 p-5 rounded-xl">
              <h3 className="font-semibold text-gray-900 mb-2">East McAlester</h3>
              <p className="text-gray-700 text-sm">Working-class neighborhoods and schools.</p>
            </div>
            <div className="bg-gray-50 p-5 rounded-xl">
              <h3 className="font-semibold text-gray-900 mb-2">West McAlester</h3>
              <p className="text-gray-700 text-sm">Retail corridors and suburban subdivisions.</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-emerald-600 to-emerald-700 text-white">
            ...
            <p className="text-emerald-100">Serving businesses and employees in Mcalester</p>
          </div>
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-blue-700 to-blue-800 text-white">
            <h2 className="text-2xl font-bold mb-1 flex items-center gap-2"><DollarSign className="h-6 w-6" /> Pricing for Mcalester</h2>
            <p className="text-blue-100">Flat rates — no hidden mileage fees in Pittsburg County</p>
          </div>
          <div className="p-8">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
              ...
              <div className="bg-red-50 rounded-xl p-5 text-center border border-red-200">
                ...
                <p className="text-xs text-gray-400 mt-2">Immediate deployment · Mcalester coverage</p>
              </div>
            </div>
            <div className="text-center">
              ...
              <p className="text-xs text-gray-500 mt-3">All rates are flat — no hidden mileage fees in Pittsburg County.</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-teal-600 to-teal-700 text-white">
            <h2 className="text-2xl font-bold mb-1">Mcalester FAQ</h2>
        ...
        <section className="bg-gradient-to-r from-red-600 to-red-700 text-white rounded-2xl shadow-lg">
          <div className="p-8 text-center">
            ...
            <h2 className="text-3xl font-bold mb-3">Emergency Process Service in Mcalester?</h2>
            <p className="text-xl mb-6 text-red-100">Available 24/7 for urgent legal document service across Pittsburg County</p>
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-blue-600 to-blue-700 text-white">
            <h2 className="text-2xl font-bold mb-1 flex items-center gap-2"><MapPin className="h-6 w-6" /> Mcalester Service Area Map</h2>
            <p className="text-blue-100">GPS-verified coverage throughout Pittsburg County</p>
          </div>
          <div className="p-8">
            <GoogleMapsEmbed
              ...
              cityName="Mcalester"
              state="Oklahoma"
              title="Mcalester Process Server Service Area"
            />
          </div>
        </section>
        ...
        <section className="bg-gradient-to-r from-blue-700 to-blue-800 text-white rounded-2xl shadow-lg">
          <div className="p-8 text-center">
            <h2 className="text-3xl font-bold mb-3">Ready to Serve Papers in Mcalester?</h2>
            <p className="text-xl mb-6 text-blue-100">GPS-tracked, notarized, court-ready — in Pittsburg County.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
      ...
      <UnifiedSchema
        ...
        breadcrumbItems={[
          ...
          { name: 'Mcalester', item: 'https://justlegalsolutions.org/service-areas/mcalester' },
        ]}
      />
    </div>
  );
