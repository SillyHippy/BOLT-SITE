...
export const metadata: Metadata = {
  title: 'Process Server Sulphur, OK | Murray County Seat',
  description: 'Licensed process server in Sulphur, Oklahoma. Serving Murray County District Court and the Chickasaw National Recreation Area.',
  keywords: 'process server Sulphur OK, serve papers Sulphur Oklahoma, legal document service Sulphur, subpoena service Sulphur',
  authors: [{ name: 'Just Legal Solutions', url: 'https://justlegalsolutions.org' }],
  robots: { index: true, follow: true },
  openGraph: {
    title: 'Process Server Sulphur, OK | Murray County Seat',
    description: 'Licensed process server in Sulphur, Oklahoma. Serving Murray County District Court and the Chickasaw National Recreation Area.',
    url: 'https://justlegalsolutions.org/service-areas/sulphur',
    siteName: 'Just Legal Solutions',
    locale: 'en_US',
    type: 'website',
  },
  alternates: {
    canonical: 'https://justlegalsolutions.org/service-areas/sulphur',
  },
};

const pageFAQs: { question: string; answer: string }[] = [
  { question: 'Do all Murray County cases file at the Murray County Courthouse?', answer: 'Yes. All district-court civil, family, and felony cases for Murray County residents file at the Murray County Courthouse. Municipal cases are handled separately at the local municipal court.' },
  { question: 'Is same-day process service available?', answer: 'Yes. Our same-day service can cover Sulphur and all surrounding areas. Call before noon for best scheduling.' },
...
const employers: { name: string; address: string; industry: string; notes: string }[] = [
  { name: 'Chickasaw Nation', address: '', industry: 'Tribal Government', notes: 'Regional operations near recreation area.' },
  { name: 'Sulphur Public Schools', address: '', industry: 'Education', notes: 'Local district.' },
  { name: 'City of Sulphur', address: '', industry: 'Government', notes: 'Municipal services.' },
  { name: 'Walmart', address: '', industry: 'Retail', notes: 'Main retail employer.' },
];

export default function SulphurProcessServerPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 text-white py-16 md:py-24">
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          <nav className="text-sm mb-6 text-blue-200" aria-label="Breadcrumb">
            ...
            <span className="mx-2">/</span>
            <span className="text-white font-medium">Sulphur</span>
          </nav>
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold leading-tight mb-5">
            Process Server<br className="hidden md:block" /> Sulphur, Oklahoma
          </h1>
          <div className="flex flex-wrap gap-4 mb-4 text-blue-200 text-sm">
            <span className="flex items-center gap-1"><Users className="h-4 w-4" /> Population: 4,994</span>
            
            <span>🚗 80 min from OKC</span>
            <span>🚗 130 min from Tulsa</span>
          </div>
          <p className="text-lg text-blue-100 mb-4 italic">Home to the Chickasaw National Recreation Area and Travertine Nature Center..</p>
          <p className="text-xl text-blue-100 mb-8 max-w-3xl leading-relaxed">
            Licensed process server in Sulphur, Oklahoma. Serving Murray County District Court and the Chickasaw National Recreation Area.
          </p>
      ...
      <div className="container mx-auto px-4 md:px-6 max-w-5xl py-12 space-y-10">
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-slate-700 to-slate-800 text-white">
            ...
            <p className="text-slate-300">Sulphur, Oklahoma</p>
          </div>
          <div className="p-8 space-y-4">
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-5">
              <p className="font-semibold text-lg text-gray-900">Murray County Courthouse</p>
              <p className="text-gray-700">PO Box 240, Sulphur, OK 73086</p>
              <p className="text-gray-600 text-sm mt-1">📞 (580) 622-3773</p>
            ...
            <div className="bg-orange-50 border border-orange-200 rounded-xl p-4">
              ...
              <p className="text-orange-700 text-sm">Chickasaw National Recreation Area has seasonal ranger housing.</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-indigo-600 to-indigo-700 text-white">
            <h2 className="text-2xl font-bold mb-1">Where We Serve Papers in Sulphur</h2>
            <p className="text-indigo-100">Local coverage across Murray County</p>
          </div>
          <div className="p-8 grid md:grid-cols-2 gap-6">
            <div className="bg-gray-50 p-5 rounded-xl">
              <h3 className="font-semibold text-gray-900 mb-2">Downtown Sulphur</h3>
              <p className="text-gray-700 text-sm">Historic district near Chickasaw National Recreation Area.</p>
            </div>
            <div className="bg-gray-50 p-5 rounded-xl">
              <h3 className="font-semibold text-gray-900 mb-2">Sulphur East</h3>
              <p className="text-gray-700 text-sm">Residential neighborhoods and schools.</p>
            </div>
            <div className="bg-gray-50 p-5 rounded-xl">
              <h3 className="font-semibold text-gray-900 mb-2">Sulphur West</h3>
              <p className="text-gray-700 text-sm">Rural lots and ranch properties.</p>
            </div>
            <div className="bg-gray-50 p-5 rounded-xl">
              <h3 className="font-semibold text-gray-900 mb-2">Travertine Nature Center Vicinity</h3>
              <p className="text-gray-700 text-sm">Seasonal ranger housing and park access areas.</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-emerald-600 to-emerald-700 text-white">
            ...
            <p className="text-emerald-100">Serving businesses and employees in Sulphur</p>
          </div>
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-blue-700 to-blue-800 text-white">
            <h2 className="text-2xl font-bold mb-1 flex items-center gap-2"><DollarSign className="h-6 w-6" /> Pricing for Sulphur</h2>
            <p className="text-blue-100">Flat rates — no hidden mileage fees in Murray County</p>
          </div>
          <div className="p-8">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
              ...
              <div className="bg-red-50 rounded-xl p-5 text-center border border-red-200">
                ...
                <p className="text-xs text-gray-400 mt-2">Immediate deployment · Sulphur coverage</p>
              </div>
            </div>
            <div className="text-center">
              ...
              <p className="text-xs text-gray-500 mt-3">All rates are flat — no hidden mileage fees in Murray County.</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-teal-600 to-teal-700 text-white">
            <h2 className="text-2xl font-bold mb-1">Sulphur FAQ</h2>
        ...
        <section className="bg-gradient-to-r from-red-600 to-red-700 text-white rounded-2xl shadow-lg">
          <div className="p-8 text-center">
            ...
            <h2 className="text-3xl font-bold mb-3">Emergency Process Service in Sulphur?</h2>
            <p className="text-xl mb-6 text-red-100">Available 24/7 for urgent legal document service across Murray County</p>
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-blue-600 to-blue-700 text-white">
            <h2 className="text-2xl font-bold mb-1 flex items-center gap-2"><MapPin className="h-6 w-6" /> Sulphur Service Area Map</h2>
            <p className="text-blue-100">GPS-verified coverage throughout Murray County</p>
          </div>
          <div className="p-8">
            <GoogleMapsEmbed
              ...
              cityName="Sulphur"
              state="Oklahoma"
              title="Sulphur Process Server Service Area"
            />
          </div>
        </section>
        ...
        <section className="bg-gradient-to-r from-blue-700 to-blue-800 text-white rounded-2xl shadow-lg">
          <div className="p-8 text-center">
            <h2 className="text-3xl font-bold mb-3">Ready to Serve Papers in Sulphur?</h2>
            <p className="text-xl mb-6 text-blue-100">GPS-tracked, notarized, court-ready — in Murray County.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
      ...
      <UnifiedSchema
        ...
        breadcrumbItems={[
          ...
          { name: 'Sulphur', item: 'https://justlegalsolutions.org/service-areas/sulphur' },
        ]}
      />
    </div>
  );
