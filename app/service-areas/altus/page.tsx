...
export const metadata: Metadata = {
  title: 'Process Server Altus, OK | Jackson County Seat',
  description: 'Licensed process server in Altus, Oklahoma. Serving Jackson County District Court, Altus Air Force Base, and southwest Oklahoma.',
  keywords: 'process server Altus OK, serve papers Altus Oklahoma, legal document service Altus, subpoena service Altus',
  authors: [{ name: 'Just Legal Solutions', url: 'https://justlegalsolutions.org' }],
  robots: { index: true, follow: true },
  openGraph: {
    title: 'Process Server Altus, OK | Jackson County Seat',
    description: 'Licensed process server in Altus, Oklahoma. Serving Jackson County District Court, Altus Air Force Base, and southwest Oklahoma.',
    url: 'https://justlegalsolutions.org/service-areas/altus',
    siteName: 'Just Legal Solutions',
    locale: 'en_US',
    type: 'website',
  },
  alternates: {
    canonical: 'https://justlegalsolutions.org/service-areas/altus',
  },
};

const pageFAQs: { question: string; answer: string }[] = [
  { question: 'Can you serve someone on Altus Air Force Base?', answer: 'Yes. Service on Altus AFB requires DBIDS access and coordination with base security forces.' },
  { question: 'Do you serve Western Oklahoma State College students?', answer: 'We verify current enrollment and serve at on-campus or off-campus addresses.' },
  { question: 'Do all Jackson County cases file at the Jackson County Courthouse?', answer: 'Yes. All district-court civil, family, and felony cases for Jackson County residents file at the Jackson County Courthouse. Municipal cases are handled separately at the local municipal court.' },
  { question: 'Is same-day process service available?', answer: 'Yes. Our same-day service can cover Altus and all surrounding areas. Call before noon for best scheduling.' },
...
const employers: { name: string; address: string; industry: string; notes: string }[] = [
  { name: 'Altus Air Force Base', address: '', industry: 'Military', notes: 'DBIDS required for on-base process service.' },
  { name: 'Jackson County Memorial Hospital', address: '', industry: 'Healthcare', notes: 'Major regional medical center.' },
  { name: 'Altus Public Schools', address: '', industry: 'Education', notes: 'Multiple campuses across the city.' },
  { name: 'Western Oklahoma State College', address: '', industry: 'Higher Education', notes: 'Faculty and commuter students.' },
  { name: 'City of Altus', address: '', industry: 'Government', notes: 'Municipal and public works.' },
  { name: 'Walmart Supercenter', address: '', industry: 'Retail', notes: 'Primary big-box employer.' },
];

export default function AltusProcessServerPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 text-white py-16 md:py-24">
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          <nav className="text-sm mb-6 text-blue-200" aria-label="Breadcrumb">
            ...
            <span className="mx-2">/</span>
            <span className="text-white font-medium">Altus</span>
          </nav>
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold leading-tight mb-5">
            Process Server<br className="hidden md:block" /> Altus, Oklahoma
          </h1>
          <div className="flex flex-wrap gap-4 mb-4 text-blue-200 text-sm">
            <span className="flex items-center gap-1"><Users className="h-4 w-4" /> Population: 18,646</span>
            
            <span>🚗 140 min from OKC</span>
            <span>🚗 225 min from Tulsa</span>
          </div>
          <p className="text-lg text-blue-100 mb-4 italic">Home to Altus Air Force Base and Western Oklahoma State College..</p>
          <p className="text-xl text-blue-100 mb-8 max-w-3xl leading-relaxed">
            Licensed process server in Altus, Oklahoma. Serving Jackson County District Court, Altus Air Force Base, and southwest Oklahoma.
          </p>
      ...
      <div className="container mx-auto px-4 md:px-6 max-w-5xl py-12 space-y-10">
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-slate-700 to-slate-800 text-white">
            ...
            <p className="text-slate-300">Altus, Oklahoma</p>
          </div>
          <div className="p-8 space-y-4">
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-5">
              <p className="font-semibold text-lg text-gray-900">Jackson County Courthouse</p>
              <p className="text-gray-700">101 N Main St, Altus, OK 73521</p>
              <p className="text-gray-600 text-sm mt-1">📞 (580) 482-0448</p>
            ...
            <div className="bg-orange-50 border border-orange-200 rounded-xl p-4">
              ...
              <p className="text-orange-700 text-sm">Altus AFB requires DBIDS access for on-base service.</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-indigo-600 to-indigo-700 text-white">
            <h2 className="text-2xl font-bold mb-1">Where We Serve Papers in Altus</h2>
            <p className="text-indigo-100">Local coverage across Jackson County</p>
          </div>
          <div className="p-8 grid md:grid-cols-2 gap-6">
            <div className="bg-gray-50 p-5 rounded-xl">
              <h3 className="font-semibold text-gray-900 mb-2">Downtown Altus</h3>
              <p className="text-gray-700 text-sm">Historic courthouse district along Main St.</p>
            </div>
            <div className="bg-gray-50 p-5 rounded-xl">
              <h3 className="font-semibold text-gray-900 mb-2">Altus AFB</h3>
              <p className="text-gray-700 text-sm">Military housing and installations requiring DBIDS access.</p>
            </div>
            <div className="bg-gray-50 p-5 rounded-xl">
              <h3 className="font-semibold text-gray-900 mb-2">WOSC Area</h3>
              <p className="text-gray-700 text-sm">Student apartments near Western Oklahoma State College.</p>
            </div>
            <div className="bg-gray-50 p-5 rounded-xl">
              <h3 className="font-semibold text-gray-900 mb-2">East Altus</h3>
              <p className="text-gray-700 text-sm">Residential subdivisions east of Main St.</p>
            </div>
            <div className="bg-gray-50 p-5 rounded-xl">
              <h3 className="font-semibold text-gray-900 mb-2">North Altus</h3>
              <p className="text-gray-700 text-sm">Newer residential development along N Main St.</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-emerald-600 to-emerald-700 text-white">
            ...
            <p className="text-emerald-100">Serving businesses and employees in Altus</p>
          </div>
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-blue-700 to-blue-800 text-white">
            <h2 className="text-2xl font-bold mb-1 flex items-center gap-2"><DollarSign className="h-6 w-6" /> Pricing for Altus</h2>
            <p className="text-blue-100">Flat rates — no hidden mileage fees in Jackson County</p>
          </div>
          <div className="p-8">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
              ...
              <div className="bg-red-50 rounded-xl p-5 text-center border border-red-200">
                ...
                <p className="text-xs text-gray-400 mt-2">Immediate deployment · Altus coverage</p>
              </div>
            </div>
            <div className="text-center">
              ...
              <p className="text-xs text-gray-500 mt-3">All rates are flat — no hidden mileage fees in Jackson County.</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-teal-600 to-teal-700 text-white">
            <h2 className="text-2xl font-bold mb-1">Altus FAQ</h2>
        ...
        <section className="bg-gradient-to-r from-red-600 to-red-700 text-white rounded-2xl shadow-lg">
          <div className="p-8 text-center">
            ...
            <h2 className="text-3xl font-bold mb-3">Emergency Process Service in Altus?</h2>
            <p className="text-xl mb-6 text-red-100">Available 24/7 for urgent legal document service across Jackson County</p>
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-blue-600 to-blue-700 text-white">
            <h2 className="text-2xl font-bold mb-1 flex items-center gap-2"><MapPin className="h-6 w-6" /> Altus Service Area Map</h2>
            <p className="text-blue-100">GPS-verified coverage throughout Jackson County</p>
          </div>
          <div className="p-8">
            <GoogleMapsEmbed
              ...
              cityName="Altus"
              state="Oklahoma"
              title="Altus Process Server Service Area"
            />
          </div>
        </section>
        ...
        <section className="bg-gradient-to-r from-blue-700 to-blue-800 text-white rounded-2xl shadow-lg">
          <div className="p-8 text-center">
            <h2 className="text-3xl font-bold mb-3">Ready to Serve Papers in Altus?</h2>
            <p className="text-xl mb-6 text-blue-100">GPS-tracked, notarized, court-ready — in Jackson County.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
      ...
      <UnifiedSchema
        ...
        breadcrumbItems={[
          ...
          { name: 'Altus', item: 'https://justlegalsolutions.org/service-areas/altus' },
        ]}
      />
    </div>
  );
