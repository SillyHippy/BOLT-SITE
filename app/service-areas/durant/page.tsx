...
export const metadata: Metadata = {
  title: 'Process Server Durant, OK | Bryan County Seat',
  description: 'Licensed process server in Durant, Oklahoma. Serving Bryan County District Court, SOSU, and the Texoma region. Rush and same-day available.',
  keywords: 'process server Durant OK, serve papers Durant Oklahoma, legal document service Durant, subpoena service Durant',
  authors: [{ name: 'Just Legal Solutions', url: 'https://justlegalsolutions.org' }],
  robots: { index: true, follow: true },
  openGraph: {
    title: 'Process Server Durant, OK | Bryan County Seat',
    description: 'Licensed process server in Durant, Oklahoma. Serving Bryan County District Court, SOSU, and the Texoma region. Rush and same-day available.',
    url: 'https://justlegalsolutions.org/service-areas/durant',
    siteName: 'Just Legal Solutions',
    locale: 'en_US',
    type: 'website',
  },
  alternates: {
    canonical: 'https://justlegalsolutions.org/service-areas/durant',
  },
};

const pageFAQs: { question: string; answer: string }[] = [
  { question: 'Do Durant cases file in Durant?', answer: 'Yes. Durant is the county seat of Bryan County. District cases file at the Bryan County Courthouse.' },
  { question: 'Can you serve Choctaw Casino Resort employees?', answer: 'Yes. We serve employees at Choctaw Casino and Resort properties in Durant and surrounding Bryan County.' },
  { question: 'Do all Bryan County cases file at the Bryan County Courthouse?', answer: 'Yes. All district-court civil, family, and felony cases for Bryan County residents file at the Bryan County Courthouse. Municipal cases are handled separately at the local municipal court.' },
  { question: 'Is same-day process service available?', answer: 'Yes. Our same-day service can cover Durant and all surrounding areas. Call before noon for best scheduling.' },
...
const employers: { name: string; address: string; industry: string; notes: string }[] = [
  { name: 'Choctaw Nation of Oklahoma', address: '', industry: 'Tribal Government', notes: 'Headquarters and casino resort in Durant.' },
  { name: 'Southeastern Oklahoma State University', address: '', industry: 'Higher Education', notes: 'Faculty and students.' },
  { name: 'AllianceHealth Durant', address: '', industry: 'Healthcare', notes: 'Regional hospital.' },
  { name: 'Durant Public Schools', address: '', industry: 'Education', notes: 'Local district.' },
  { name: 'City of Durant', address: '', industry: 'Government', notes: 'Municipal operations.' },
  { name: 'BrucePac', address: '', industry: 'Food Processing', notes: 'Protein processing plant.' },
  { name: 'Walmart Supercenter', address: '', industry: 'Retail', notes: 'Major retail employer.' },
];

export default function DurantProcessServerPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 text-white py-16 md:py-24">
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          <nav className="text-sm mb-6 text-blue-200" aria-label="Breadcrumb">
            ...
            <span className="mx-2">/</span>
            <span className="text-white font-medium">Durant</span>
          </nav>
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold leading-tight mb-5">
            Process Server<br className="hidden md:block" /> Durant, Oklahoma
          </h1>
          <div className="flex flex-wrap gap-4 mb-4 text-blue-200 text-sm">
            <span className="flex items-center gap-1"><Users className="h-4 w-4" /> Population: 19,746</span>
            
            <span>🚗 110 min from OKC</span>
            <span>🚗 140 min from Tulsa</span>
          </div>
          <p className="text-lg text-blue-100 mb-4 italic">Home to Southeastern Oklahoma State University and the Choctaw Casino Resort..</p>
          <p className="text-xl text-blue-100 mb-8 max-w-3xl leading-relaxed">
            Licensed process server in Durant, Oklahoma. Serving Bryan County District Court, SOSU, and the Texoma region. Rush and same-day available.
          </p>
      ...
      <div className="container mx-auto px-4 md:px-6 max-w-5xl py-12 space-y-10">
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-slate-700 to-slate-800 text-white">
            ...
            <p className="text-slate-300">Durant, Oklahoma</p>
          </div>
          <div className="p-8 space-y-4">
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-5">
              <p className="font-semibold text-lg text-gray-900">Bryan County Courthouse</p>
              <p className="text-gray-700">402 W Evergreen St, Durant, OK 74701</p>
              <p className="text-gray-600 text-sm mt-1">📞 (580) 924-1446</p>
            ...
            <div className="bg-orange-50 border border-orange-200 rounded-xl p-4">
              ...
              <p className="text-orange-700 text-sm">Choctaw Nation tribal jurisdiction common in eastern Bryan County.</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-indigo-600 to-indigo-700 text-white">
            <h2 className="text-2xl font-bold mb-1">Where We Serve Papers in Durant</h2>
            <p className="text-indigo-100">Local coverage across Bryan County</p>
          </div>
          <div className="p-8 grid md:grid-cols-2 gap-6">
            <div className="bg-gray-50 p-5 rounded-xl">
              <h3 className="font-semibold text-gray-900 mb-2">Downtown Durant</h3>
              <p className="text-gray-700 text-sm">Courthouse district, SOSU campus, and casino resort corridor.</p>
            </div>
            <div className="bg-gray-50 p-5 rounded-xl">
              <h3 className="font-semibold text-gray-900 mb-2">SOSU Area</h3>
              <p className="text-gray-700 text-sm">Student apartments and faculty housing.</p>
            </div>
            <div className="bg-gray-50 p-5 rounded-xl">
              <h3 className="font-semibold text-gray-900 mb-2">North Durant</h3>
              <p className="text-gray-700 text-sm">Residential subdivisions and medical offices along University Blvd.</p>
            </div>
            <div className="bg-gray-50 p-5 rounded-xl">
              <h3 className="font-semibold text-gray-900 mb-2">West Durant</h3>
              <p className="text-gray-700 text-sm">Retail corridors and working-class neighborhoods.</p>
            </div>
            <div className="bg-gray-50 p-5 rounded-xl">
              <h3 className="font-semibold text-gray-900 mb-2">Durant Southeast</h3>
              <p className="text-gray-700 text-sm">Industrial area near the airport.</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-emerald-600 to-emerald-700 text-white">
            ...
            <p className="text-emerald-100">Serving businesses and employees in Durant</p>
          </div>
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-blue-700 to-blue-800 text-white">
            <h2 className="text-2xl font-bold mb-1 flex items-center gap-2"><DollarSign className="h-6 w-6" /> Pricing for Durant</h2>
            <p className="text-blue-100">Flat rates — no hidden mileage fees in Bryan County</p>
          </div>
          <div className="p-8">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
              ...
              <div className="bg-red-50 rounded-xl p-5 text-center border border-red-200">
                ...
                <p className="text-xs text-gray-400 mt-2">Immediate deployment · Durant coverage</p>
              </div>
            </div>
            <div className="text-center">
              ...
              <p className="text-xs text-gray-500 mt-3">All rates are flat — no hidden mileage fees in Bryan County.</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-teal-600 to-teal-700 text-white">
            <h2 className="text-2xl font-bold mb-1">Durant FAQ</h2>
        ...
        <section className="bg-gradient-to-r from-red-600 to-red-700 text-white rounded-2xl shadow-lg">
          <div className="p-8 text-center">
            ...
            <h2 className="text-3xl font-bold mb-3">Emergency Process Service in Durant?</h2>
            <p className="text-xl mb-6 text-red-100">Available 24/7 for urgent legal document service across Bryan County</p>
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-blue-600 to-blue-700 text-white">
            <h2 className="text-2xl font-bold mb-1 flex items-center gap-2"><MapPin className="h-6 w-6" /> Durant Service Area Map</h2>
            <p className="text-blue-100">GPS-verified coverage throughout Bryan County</p>
          </div>
          <div className="p-8">
            <GoogleMapsEmbed
              ...
              cityName="Durant"
              state="Oklahoma"
              title="Durant Process Server Service Area"
            />
          </div>
        </section>
        ...
        <section className="bg-gradient-to-r from-blue-700 to-blue-800 text-white rounded-2xl shadow-lg">
          <div className="p-8 text-center">
            <h2 className="text-3xl font-bold mb-3">Ready to Serve Papers in Durant?</h2>
            <p className="text-xl mb-6 text-blue-100">GPS-tracked, notarized, court-ready — in Bryan County.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
      ...
      <UnifiedSchema
        ...
        breadcrumbItems={[
          ...
          { name: 'Durant', item: 'https://justlegalsolutions.org/service-areas/durant' },
        ]}
      />
    </div>
  );
