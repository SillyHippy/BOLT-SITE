...
export const metadata: Metadata = {
  title: 'Process Server Pryor, OK | Licensed Legal Document Service',
  description: 'Licensed process server in Pryor, Oklahoma. GPS-tracked and court-ready. Call (539) 367-6832.',
  keywords: 'process server Pryor OK, serve papers Pryor Oklahoma, legal document service Pryor, subpoena service Pryor',
  ...
  alternates: {
    canonical: 'https://justlegalsolutions.org/service-areas/pryor',
  },
};

const pageFAQs: { question: string; answer: string }[] = [
  { question: 'Do Pryor cases file in Pryor?', answer: 'Yes. Pryor is the county seat of Mayes County. District cases file at the Mayes County Courthouse.' },
  { question: 'Can you serve MidAmerica Industrial Park employees?', answer: 'Yes. MidAmerica Industrial Park service may require guard-gate coordination and advance notice.' },
  { question: 'Do all Mayes County cases file at the Mayes County Courthouse?', answer: 'Yes. All district-court civil, family, and felony cases for Mayes County residents file at the Mayes County Courthouse. Municipal cases are handled separately at the local municipal court.' },
  { question: 'Is same-day process service available?', answer: 'Yes. Our same-day service can cover Pryor and all surrounding areas. Call before noon for best scheduling.' },
...
const employers: { name: string; address: string; industry: string; notes: string }[] = [
  { name: 'MidAmerica Industrial Park', address: '', industry: 'Industrial', notes: 'Multiple tenant employers.' },
  { name: 'Pryor Public Schools', address: '', industry: 'Education', notes: 'Local district.' },
  { name: 'City of Pryor', address: '', industry: 'Government', notes: 'Municipal services.' },
  { name: 'Northeastern Oklahoma A&M College', address: '', industry: 'Higher Education', notes: 'Pryor satellite programs.' },
  { name: 'Walmart Supercenter', address: '', industry: 'Retail', notes: 'Primary retail.' },
];

export default function PryorProcessServerPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 text-white py-16 md:py-24">
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          <nav className="text-sm mb-6 text-blue-200" aria-label="Breadcrumb">
            ...
            <span className="mx-2">/</span>
            <span className="text-white font-medium">Pryor</span>
          </nav>
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold leading-tight mb-5">
            Process Server<br className="hidden md:block" /> Pryor, Oklahoma
          </h1>
          <div className="flex flex-wrap gap-4 mb-4 text-blue-200 text-sm">
            <span className="flex items-center gap-1"><Users className="h-4 w-4" /> Population: 9,569</span>
            
            <span>🚗 125 min from OKC</span>
            <span>🚗 45 min from Tulsa</span>
          </div>
          <p className="text-lg text-blue-100 mb-4 italic">Home to the MidAmerica Industrial Park, one of the largest rural industrial parks in the U.S..</p>
          <p className="text-xl text-blue-100 mb-8 max-w-3xl leading-relaxed">
            Licensed process server in Pryor, Oklahoma. GPS-tracked and court-ready. Call (539) 367-6832.
          </p>
      ...
      <div className="container mx-auto px-4 md:px-6 max-w-5xl py-12 space-y-10">
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-slate-700 to-slate-800 text-white">
            ...
            <p className="text-slate-300">Pryor, Oklahoma</p>
          </div>
          <div className="p-8 space-y-4">
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-5">
              <p className="font-semibold text-lg text-gray-900">Mayes County Courthouse</p>
              <p className="text-gray-700">PO Box 95, Pryor, OK 74362</p>
              <p className="text-gray-600 text-sm mt-1">📞 (918) 825-2185</p>
            ...
            <div className="bg-orange-50 border border-orange-200 rounded-xl p-4">
              ...
              <p className="text-orange-700 text-sm">MidAmerica Industrial Park has guarded entrances; coordinate in advance.</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-indigo-600 to-indigo-700 text-white">
            <h2 className="text-2xl font-bold mb-1">Where We Serve Papers in Pryor</h2>
            <p className="text-indigo-100">Local coverage across Mayes County</p>
          </div>
          <div className="p-8 grid md:grid-cols-2 gap-6">
            <div className="bg-gray-50 p-5 rounded-xl">
              <h3 className="font-semibold text-gray-900 mb-2">Downtown Pryor</h3>
              <p className="text-gray-700 text-sm">Historic Main St and Mayes County Courthouse.</p>
            </div>
            <div className="bg-gray-50 p-5 rounded-xl">
              <h3 className="font-semibold text-gray-900 mb-2">MidAmerica Industrial Park</h3>
              <p className="text-gray-700 text-sm">Large rural industrial park with multiple employers.</p>
            </div>
            <div className="bg-gray-50 p-5 rounded-xl">
              <h3 className="font-semibold text-gray-900 mb-2">Pryor East</h3>
              <p className="text-gray-700 text-sm">Residential subdivisions and schools.</p>
            </div>
            <div className="bg-gray-50 p-5 rounded-xl">
              <h3 className="font-semibold text-gray-900 mb-2">Pryor West</h3>
              <p className="text-gray-700 text-sm">Working-class neighborhoods near Highway 69.</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-emerald-600 to-emerald-700 text-white">
            ...
            <p className="text-emerald-100">Serving businesses and employees in Pryor</p>
          </div>
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-blue-700 to-blue-800 text-white">
            <h2 className="text-2xl font-bold mb-1 flex items-center gap-2"><DollarSign className="h-6 w-6" /> Pricing for Pryor</h2>
            <p className="text-blue-100">Flat rates — no hidden mileage fees in Mayes County</p>
          </div>
          <div className="p-8">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
              ...
              <div className="bg-red-50 rounded-xl p-5 text-center border border-red-200">
                ...
                <p className="text-xs text-gray-400 mt-2">Immediate deployment · Pryor coverage</p>
              </div>
            </div>
            <div className="text-center">
              ...
              <p className="text-xs text-gray-500 mt-3">All rates are flat — no hidden mileage fees in Mayes County.</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-teal-600 to-teal-700 text-white">
            <h2 className="text-2xl font-bold mb-1">Pryor FAQ</h2>
        ...
        <section className="bg-gradient-to-r from-red-600 to-red-700 text-white rounded-2xl shadow-lg">
          <div className="p-8 text-center">
            ...
            <h2 className="text-3xl font-bold mb-3">Emergency Process Service in Pryor?</h2>
            <p className="text-xl mb-6 text-red-100">Available 24/7 for urgent legal document service across Mayes County</p>
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-blue-600 to-blue-700 text-white">
            <h2 className="text-2xl font-bold mb-1 flex items-center gap-2"><MapPin className="h-6 w-6" /> Pryor Service Area Map</h2>
            <p className="text-blue-100">GPS-verified coverage throughout Mayes County</p>
          </div>
          <div className="p-8">
            <GoogleMapsEmbed
              ...
              cityName="Pryor"
              state="Oklahoma"
              title="Pryor Process Server Service Area"
            />
          </div>
        </section>
        ...
        <section className="bg-gradient-to-r from-blue-700 to-blue-800 text-white rounded-2xl shadow-lg">
          <div className="p-8 text-center">
            <h2 className="text-3xl font-bold mb-3">Ready to Serve Papers in Pryor?</h2>
            <p className="text-xl mb-6 text-blue-100">GPS-tracked, notarized, court-ready — in Mayes County.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
      ...
      <UnifiedSchema
        ...
        breadcrumbItems={[
          ...
          { name: 'Pryor', item: 'https://justlegalsolutions.org/service-areas/pryor' },
        ]}
      />
    </div>
  );
