...
export const metadata: Metadata = {
  title: 'Process Server Ponca City, OK | Kay County Seat',
  description: 'Licensed process server in Ponca City, Oklahoma. Serving Kay County District Court and north-central Oklahoma. Rush and same-day available.',
  keywords: 'process server Ponca City OK, serve papers Ponca City Oklahoma, legal document service Ponca City, subpoena service Ponca City',
  authors: [{ name: 'Just Legal Solutions', url: 'https://justlegalsolutions.org' }],
  robots: { index: true, follow: true },
  openGraph: {
    title: 'Process Server Ponca City, OK | Kay County Seat',
    description: 'Licensed process server in Ponca City, Oklahoma. Serving Kay County District Court and north-central Oklahoma. Rush and same-day available.',
    url: 'https://justlegalsolutions.org/service-areas/ponca-city',
    siteName: 'Just Legal Solutions',
    locale: 'en_US',
    type: 'website',
  },
  alternates: {
    canonical: 'https://justlegalsolutions.org/service-areas/ponca-city',
  },
};

const pageFAQs: { question: string; answer: string }[] = [
  { question: 'Do Ponca City cases file in Ponca City?', answer: 'No. Ponca City is in Kay County. District cases file at the Kay County Courthouse in Newkirk.' },
  { question: 'Do all Kay County cases file at the Kay County Courthouse?', answer: 'Yes. All district-court civil, family, and felony cases for Kay County residents file at the Kay County Courthouse. Municipal cases are handled separately at the local municipal court.' },
  { question: 'Is same-day process service available?', answer: 'Yes. Our same-day service can cover Ponca-City and all surrounding areas. Call before noon for best scheduling.' },
...
const employers: { name: string; address: string; industry: string; notes: string }[] = [
  { name: 'ConocoPhillips', address: '', industry: 'Energy', notes: 'Legacy refinery and research.' },
  { name: 'Ponca City Public Schools', address: '', industry: 'Education', notes: 'Local district.' },
  { name: 'City of Ponca City', address: '', industry: 'Government', notes: 'Municipal services.' },
  { name: 'Walmart Supercenter', address: '', industry: 'Retail', notes: 'Primary retail.' },
  { name: 'Stillwater Medical Center - Ponca', address: '', industry: 'Healthcare', notes: 'Regional clinic and hospital.' },
];

export default function PoncaCityProcessServerPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 text-white py-16 md:py-24">
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          <nav className="text-sm mb-6 text-blue-200" aria-label="Breadcrumb">
            ...
            <span className="mx-2">/</span>
            <span className="text-white font-medium">Ponca City</span>
          </nav>
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold leading-tight mb-5">
            Process Server<br className="hidden md:block" /> Ponca City, Oklahoma
          </h1>
          <div className="flex flex-wrap gap-4 mb-4 text-blue-200 text-sm">
            <span className="flex items-center gap-1"><Users className="h-4 w-4" /> Population: 24,326</span>
            
            <span>🚗 100 min from OKC</span>
            <span>🚗 75 min from Tulsa</span>
          </div>
          <p className="text-lg text-blue-100 mb-4 italic">Home to the Pioneer Woman Museum and the ConocoPhillips legacy in Kay County..</p>
          <p className="text-xl text-blue-100 mb-8 max-w-3xl leading-relaxed">
            Licensed process server in Ponca City, Oklahoma. Serving Kay County District Court and north-central Oklahoma. Rush and same-day available.
          </p>
      ...
      <div className="container mx-auto px-4 md:px-6 max-w-5xl py-12 space-y-10">
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-slate-700 to-slate-800 text-white">
            ...
            <p className="text-slate-300">Ponca City, Oklahoma</p>
          </div>
          <div className="p-8 space-y-4">
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-5">
              <p className="font-semibold text-lg text-gray-900">Kay County Courthouse</p>
              <p className="text-gray-700">PO Box 450, Newkirk, OK 74647</p>
              <p className="text-gray-600 text-sm mt-1">📞 (580) 362-3777</p>
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-indigo-600 to-indigo-700 text-white">
            <h2 className="text-2xl font-bold mb-1">Where We Serve Papers in Ponca City</h2>
            <p className="text-indigo-100">Local coverage across Kay County</p>
          </div>
          <div className="p-8 grid md:grid-cols-2 gap-6">
            <div className="bg-gray-50 p-5 rounded-xl">
              <h3 className="font-semibold text-gray-900 mb-2">Downtown Ponca City</h3>
              <p className="text-gray-700 text-sm">Historic commercial district and municipal offices.</p>
            </div>
            <div className="bg-gray-50 p-5 rounded-xl">
              <h3 className="font-semibold text-gray-900 mb-2">East Ponca City</h3>
              <p className="text-gray-700 text-sm">Working-class neighborhoods near ConocoLake Park.</p>
            </div>
            <div className="bg-gray-50 p-5 rounded-xl">
              <h3 className="font-semibold text-gray-900 mb-2">West Ponca City</h3>
              <p className="text-gray-700 text-sm">Residential subdivisions and schools.</p>
            </div>
            <div className="bg-gray-50 p-5 rounded-xl">
              <h3 className="font-semibold text-gray-900 mb-2">Ponca City North</h3>
              <p className="text-gray-700 text-sm">Industrial corridor and refinery-adjacent areas.</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-emerald-600 to-emerald-700 text-white">
            ...
            <p className="text-emerald-100">Serving businesses and employees in Ponca City</p>
          </div>
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-blue-700 to-blue-800 text-white">
            <h2 className="text-2xl font-bold mb-1 flex items-center gap-2"><DollarSign className="h-6 w-6" /> Pricing for Ponca City</h2>
            <p className="text-blue-100">Flat rates — no hidden mileage fees in Kay County</p>
          </div>
          <div className="p-8">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
              ...
              <div className="bg-red-50 rounded-xl p-5 text-center border border-red-200">
                ...
                <p className="text-xs text-gray-400 mt-2">Immediate deployment · Ponca City coverage</p>
              </div>
            </div>
            <div className="text-center">
              ...
              <p className="text-xs text-gray-500 mt-3">All rates are flat — no hidden mileage fees in Kay County.</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-teal-600 to-teal-700 text-white">
            <h2 className="text-2xl font-bold mb-1">Ponca City FAQ</h2>
        ...
        <section className="bg-gradient-to-r from-red-600 to-red-700 text-white rounded-2xl shadow-lg">
          <div className="p-8 text-center">
            ...
            <h2 className="text-3xl font-bold mb-3">Emergency Process Service in Ponca City?</h2>
            <p className="text-xl mb-6 text-red-100">Available 24/7 for urgent legal document service across Kay County</p>
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-blue-600 to-blue-700 text-white">
            <h2 className="text-2xl font-bold mb-1 flex items-center gap-2"><MapPin className="h-6 w-6" /> Ponca City Service Area Map</h2>
            <p className="text-blue-100">GPS-verified coverage throughout Kay County</p>
          </div>
          <div className="p-8">
            <GoogleMapsEmbed
              ...
              cityName="Ponca City"
              state="Oklahoma"
              title="Ponca City Process Server Service Area"
            />
          </div>
        </section>
        ...
        <section className="bg-gradient-to-r from-blue-700 to-blue-800 text-white rounded-2xl shadow-lg">
          <div className="p-8 text-center">
            <h2 className="text-3xl font-bold mb-3">Ready to Serve Papers in Ponca City?</h2>
            <p className="text-xl mb-6 text-blue-100">GPS-tracked, notarized, court-ready — in Kay County.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
      ...
      <UnifiedSchema
        ...
        breadcrumbItems={[
          ...
          { name: 'Ponca City', item: 'https://justlegalsolutions.org/service-areas/ponca-city' },
        ]}
      />
    </div>
  );
