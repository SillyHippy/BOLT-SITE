...
export const metadata: Metadata = {
  ...
  keywords: "process server Shawnee OK, legal document service Shawnee Oklahoma, serve papers Shawnee, court documents Shawnee, subpoena service Shawnee, licensed process server Oklahoma",
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <section className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 text-white py-16 md:py-20">
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          <nav className="text-sm mb-6 text-blue-200">
            ...
            <span className="mx-2">/</span>
            <span className="text-white">Shawnee</span>
          </nav>
          ...
          <h1 className="text-3xl md:text-5xl font-bold leading-tight mb-4">Process Server Shawnee, OK | Pottawatomie County Seat</h1>
          <p className="text-xl text-blue-100 mb-8 max-w-3xl">Licensed process server in Shawnee, Oklahoma. Serving Pottawatomie County, Citizen Potawatomi Nation, OBU, and nearby areas. Rush and same-day available.</p>
      ...
      <div className="container mx-auto px-4 md:px-6 max-w-5xl py-12">
        ...
        <section className="bg-white rounded-xl shadow-md p-8 mb-10">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Service Pricing for Shawnee</h2>
        ...
        <section className="bg-white rounded-xl shadow-md p-8 mb-10">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Shawnee FAQ</h2>
          <div className="space-y-5">
                <div className="border-b border-gray-200 pb-5 last:border-0">
                  <h3 className="font-semibold text-lg text-gray-800 mb-2">How does Citizen Potawatomi Nation tribal jurisdiction work in Shawnee?</h3>
                  <p className="text-gray-600">Shawnee is the headquarters of the Citizen Potawatomi Nation. While most civil and criminal cases are handled by the state court system (Pottawatomie County District Court), some matters involving tribal members or tribal lands may fall under tribal court jurisdiction. We can serve documents in either venue once your attorney has confirmed the correct court.</p>
                </div>
                <div className="border-b border-gray-200 pb-5 last:border-0">
                  <h3 className="font-semibold text-lg text-gray-800 mb-2">Can you serve papers at FireLake Casino?</h3>
                  <p className="text-gray-600">Yes. FireLake Casino employs hundreds of people and operates 24/7. We coordinate with Citizen Potawatomi Nation HR for workplace service during standard business hours, or serve employees at their residences in Shawnee and surrounding communities after hours.</p>
                </div>
                <div className="border-b border-gray-200 pb-5 last:border-0">
                  <h3 className="font-semibold text-lg text-gray-800 mb-2">How do you handle OBU student housing turnover?</h3>
                  <p className="text-gray-600">Oklahoma Baptist University students move frequently, especially between semesters. We verify current occupancy through university directory services (where permitted), USPS forwarding data, and Oklahoma voter-registration records before attempting service.</p>
                </div>
                <div className="border-b border-gray-200 pb-5 last:border-0">
                  <h3 className="font-semibold text-lg text-gray-800 mb-2">Is same-day service available in Shawnee?</h3>
                  <p className="text-gray-600">Yes. Shawnee is a core service zone for Just Legal Solutions. Same-Day service ($265) is available seven days a week, subject to order volume and cutoff times. Call (539) 367-6832 to confirm availability.</p>
                </div>
          </div>
        ...
        <section className="bg-blue-900 text-white rounded-xl p-8 text-center">
          ...
          <p className="text-blue-100 mb-6 max-w-2xl mx-auto">Licensed, bonded, and GPS-verified. Flat-rate pricing that covers every address in Shawnee, Oklahoma.</p>
