...
export const metadata: Metadata = {
  title: 'Process Server Shawnee, OK | Pottawatomie County Seat',
  description: 'Licensed process server in Shawnee, Oklahoma. Serving Pottawatomie County, Citizen Potawatomi Nation, OBU, and nearby areas. Rush and same-day available.',
  keywords: 'process server Shawnee OK, serve papers Shawnee Oklahoma, legal document service Shawnee, subpoena service Shawnee',
  authors: [{ name: 'Just Legal Solutions', url: 'https://justlegalsolutions.org' }],
  robots: { index: true, follow: true },
  openGraph: {
    title: 'Process Server Shawnee, OK | Pottawatomie County Seat',
    description: 'Licensed process server in Shawnee, Oklahoma. Serving Pottawatomie County, Citizen Potawatomi Nation, OBU, and nearby areas. Rush and same-day available.',
    url: 'https://justlegalsolutions.org/service-areas/shawnee',
    siteName: 'Just Legal Solutions',
    locale: 'en_US',
    type: 'website',
  },
  alternates: {
    canonical: 'https://justlegalsolutions.org/service-areas/shawnee',
  },
};

const pageFAQs: { question: string; answer: string }[] = [
  { question: 'Do Shawnee cases file in Shawnee?', answer: 'Yes. Shawnee is the county seat of Pottawatomie County. District cases file at the Pottawatomie County Courthouse.' },
  { question: 'Can you serve OBU students?', answer: 'We verify enrollment and serve Oklahoma Baptist University students at on-campus and off-campus addresses.' },
  { question: 'Do all Pottawatomie County cases file at the Pottawatomie County Courthouse?', answer: 'Yes. All district-court civil, family, and felony cases for Pottawatomie County residents file at the Pottawatomie County Courthouse. Municipal cases are handled separately at the local municipal court.' },
  { question: 'Is same-day process service available?', answer: 'Yes. Our same-day service can cover Shawnee and all surrounding areas. Call before noon for best scheduling.' },
...
const employers: { name: string; address: string; industry: string; notes: string }[] = [
  { name: 'St. Anthony\'s Shawnee Hospital', address: '', industry: 'Healthcare', notes: 'Regional medical center.' },
  { name: 'Shawnee Public Schools', address: '', industry: 'Education', notes: 'Major district employer.' },
  { name: 'Oklahoma Baptist University', address: '', industry: 'Higher Education', notes: 'Faculty and students.' },
  { name: 'City of Shawnee', address: '', industry: 'Government', notes: 'Municipal services.' },
  { name: 'Citizen Potawatomi Nation', address: '', industry: 'Tribal Government', notes: 'Tribal government and enterprises.' },
  { name: 'Walmart Supercenter', address: '', industry: 'Retail', notes: 'Primary retail.' },
];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 text-white py-16 md:py-24">
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          <nav className="text-sm mb-6 text-blue-200" aria-label="Breadcrumb">
            ...
            <span className="mx-2">/</span>
            <span className="text-white font-medium">Shawnee</span>
          </nav>
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold leading-tight mb-5">
            Process Server<br className="hidden md:block" /> Shawnee, Oklahoma
          </h1>
          <div className="flex flex-wrap gap-4 mb-4 text-blue-200 text-sm">
            <span className="flex items-center gap-1"><Users className="h-4 w-4" /> Population: 31,671</span>
            
            <span>🚗 40 min from OKC</span>
            <span>🚗 70 min from Tulsa</span>
          </div>
          <p className="text-lg text-blue-100 mb-4 italic">Home to Oklahoma Baptist University and the St. Anthony Shawnee Hospital..</p>
          <p className="text-xl text-blue-100 mb-8 max-w-3xl leading-relaxed">
            Licensed process server in Shawnee, Oklahoma. Serving Pottawatomie County, Citizen Potawatomi Nation, OBU, and nearby areas. Rush and same-day available.
          </p>
      ...
      <div className="container mx-auto px-4 md:px-6 max-w-5xl py-12 space-y-10">
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-slate-700 to-slate-800 text-white">
            ...
            <p className="text-slate-300">Shawnee, Oklahoma</p>
          </div>
          <div className="p-8 space-y-4">
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-5">
              <p className="font-semibold text-lg text-gray-900">Pottawatomie County Courthouse</p>
              <p className="text-gray-700">325 N Broadway St, Shawnee, OK 74801</p>
              <p className="text-gray-600 text-sm mt-1">📞 (405) 273-3624</p>
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-xl p-5">
              ...
              <p className="text-gray-700 text-sm">Shawnee Municipal Court</p>
              <p className="text-gray-600 text-sm">16 W 9th St, Shawnee, OK 74801</p>
              <p className="text-gray-600 text-sm">📞 (405) 878-1602</p>
            </div>
            
            <div className="bg-orange-50 border border-orange-200 rounded-xl p-4">
              <p className="font-semibold text-orange-800">Local Service Notes</p>
              <p className="text-orange-700 text-sm">Citizen Potawatomi Nation tribal jurisdiction in eastern Pottawatomie County.</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-indigo-600 to-indigo-700 text-white">
            <h2 className="text-2xl font-bold mb-1">Where We Serve Papers in Shawnee</h2>
            <p className="text-indigo-100">Local coverage across Pottawatomie County</p>
          </div>
          <div className="p-8 grid md:grid-cols-2 gap-6">
            <div className="bg-gray-50 p-5 rounded-xl">
              <h3 className="font-semibold text-gray-900 mb-2">Downtown Shawnee</h3>
              <p className="text-gray-700 text-sm">Courthouse district and historic commercial core.</p>
            </div>
            <div className="bg-gray-50 p-5 rounded-xl">
              <h3 className="font-semibold text-gray-900 mb-2">OBU Area</h3>
              <p className="text-gray-700 text-sm">Oklahoma Baptist University campus and student housing.</p>
            </div>
            <div className="bg-gray-50 p-5 rounded-xl">
              <h3 className="font-semibold text-gray-900 mb-2">North Shawnee</h3>
              <p className="text-gray-700 text-sm">St. Anthony's Hospital district and medical offices.</p>
            </div>
            <div className="bg-gray-50 p-5 rounded-xl">
              <h3 className="font-semibold text-gray-900 mb-2">West Shawnee</h3>
              <p className="text-gray-700 text-sm">Suburban subdivisions and newer retail.</p>
            </div>
            <div className="bg-gray-50 p-5 rounded-xl">
              <h3 className="font-semibold text-gray-900 mb-2">Tecumseh Border</h3>
              <p className="text-gray-700 text-sm">Residential areas near the Tecumseh line.</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-emerald-600 to-emerald-700 text-white">
            ...
            <p className="text-emerald-100">Serving businesses and employees in Shawnee</p>
          </div>
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-blue-700 to-blue-800 text-white">
            <h2 className="text-2xl font-bold mb-1 flex items-center gap-2"><DollarSign className="h-6 w-6" /> Pricing for Shawnee</h2>
            <p className="text-blue-100">Flat rates — no hidden mileage fees in Pottawatomie County</p>
          </div>
          <div className="p-8">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
              ...
              <div className="bg-red-50 rounded-xl p-5 text-center border border-red-200">
                ...
                <p className="text-xs text-gray-400 mt-2">Immediate deployment · Shawnee coverage</p>
              </div>
            </div>
            <div className="text-center">
              ...
              <p className="text-xs text-gray-500 mt-3">All rates are flat — no hidden mileage fees in Pottawatomie County.</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-teal-600 to-teal-700 text-white">
            <h2 className="text-2xl font-bold mb-1">Shawnee FAQ</h2>
        ...
        <section className="bg-gradient-to-r from-red-600 to-red-700 text-white rounded-2xl shadow-lg">
          <div className="p-8 text-center">
            ...
            <h2 className="text-3xl font-bold mb-3">Emergency Process Service in Shawnee?</h2>
            <p className="text-xl mb-6 text-red-100">Available 24/7 for urgent legal document service across Pottawatomie County</p>
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-blue-600 to-blue-700 text-white">
            <h2 className="text-2xl font-bold mb-1 flex items-center gap-2"><MapPin className="h-6 w-6" /> Shawnee Service Area Map</h2>
            <p className="text-blue-100">GPS-verified coverage throughout Pottawatomie County</p>
          </div>
          <div className="p-8">
            <GoogleMapsEmbed
              ...
              cityName="Shawnee"
              state="Oklahoma"
              title="Shawnee Process Server Service Area"
            />
          </div>
        </section>
        ...
        <section className="bg-gradient-to-r from-blue-700 to-blue-800 text-white rounded-2xl shadow-lg">
          <div className="p-8 text-center">
            <h2 className="text-3xl font-bold mb-3">Ready to Serve Papers in Shawnee?</h2>
            <p className="text-xl mb-6 text-blue-100">GPS-tracked, notarized, court-ready — in Pottawatomie County.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
      ...
      <UnifiedSchema
        ...
        breadcrumbItems={[
          ...
          { name: 'Shawnee', item: 'https://justlegalsolutions.org/service-areas/shawnee' },
        ]}
      />
    </div>
  );
