...
const brokenArrowFAQs = [
  ...
  },
  {
    ...
    answer: "We serve all areas of Broken Arrow including downtown, Rose District, Arrow Springs, Forest Ridge, Aspen Creek, New Orleans Park, and all surrounding neighborhoods. Our coverage extends throughout Tulsa County."
  },
  {
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "FAQPage",
            "mainEntity": brokenArrowFAQs.map((faq) => ({
              "@type": "Question",
              "name": faq.question,
              "acceptedAnswer": {
                "@type": "Answer",
