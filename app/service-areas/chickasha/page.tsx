...
export const metadata: Metadata = {
  title: 'Process Server Chickasha, OK | Grady County Seat',
  description: 'Licensed process server in Chickasha, Oklahoma. Serving Grady County District Court, USAO, and surrounding communities. Rush and same-day available.',
  keywords: 'process server Chickasha OK, serve papers Chickasha Oklahoma, legal document service Chickasha, subpoena service Chickasha',
  authors: [{ name: 'Just Legal Solutions', url: 'https://justlegalsolutions.org' }],
  robots: { index: true, follow: true },
  openGraph: {
    title: 'Process Server Chickasha, OK | Grady County Seat',
    description: 'Licensed process server in Chickasha, Oklahoma. Serving Grady County District Court, USAO, and surrounding communities. Rush and same-day available.',
    url: 'https://justlegalsolutions.org/service-areas/chickasha',
    siteName: 'Just Legal Solutions',
    locale: 'en_US',
    type: 'website',
  },
  alternates: {
    canonical: 'https://justlegalsolutions.org/service-areas/chickasha',
  },
};

const pageFAQs: { question: string; answer: string }[] = [
  { question: 'Do Chickasha cases file in Chickasha?', answer: 'Yes. Chickasha is the county seat of Grady County. District cases file at the Grady County Courthouse.' },
  { question: 'Can you serve USAO students?', answer: 'We verify enrollment and serve at on-campus and off-campus student residences.' },
  { question: 'Do all Grady County cases file at the Grady County Courthouse?', answer: 'Yes. All district-court civil, family, and felony cases for Grady County residents file at the Grady County Courthouse. Municipal cases are handled separately at the local municipal court.' },
  { question: 'Is same-day process service available?', answer: 'Yes. Our same-day service can cover Chickasha and all surrounding areas. Call before noon for best scheduling.' },
...
const employers: { name: string; address: string; industry: string; notes: string }[] = [
  { name: 'University of Science and Arts of Oklahoma', address: '', industry: 'Higher Education', notes: 'Faculty and residential students.' },
  { name: 'Chickasha Public Schools', address: '', industry: 'Education', notes: 'Local district employer.' },
  { name: 'Grady Memorial Hospital', address: '', industry: 'Healthcare', notes: 'Regional hospital.' },
  { name: 'City of Chickasha', address: '', industry: 'Government', notes: 'Municipal operations.' },
  { name: 'Walmart Supercenter', address: '', industry: 'Retail', notes: 'Main retail employer.' },
  { name: 'Nestle Purina', address: '', industry: 'Manufacturing', notes: 'Pet food manufacturing plant.' },
];

export default function ChickashaProcessServerPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 text-white py-16 md:py-24">
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          <nav className="text-sm mb-6 text-blue-200" aria-label="Breadcrumb">
            ...
            <span className="mx-2">/</span>
            <span className="text-white font-medium">Chickasha</span>
          </nav>
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold leading-tight mb-5">
            Process Server<br className="hidden md:block" /> Chickasha, Oklahoma
          </h1>
          <div className="flex flex-wrap gap-4 mb-4 text-blue-200 text-sm">
            <span className="flex items-center gap-1"><Users className="h-4 w-4" /> Population: 16,539</span>
            
            <span>🚗 40 min from OKC</span>
            <span>🚗 95 min from Tulsa</span>
          </div>
          <p className="text-lg text-blue-100 mb-4 italic">Home to the University of Science and Arts of Oklahoma and the annual Festival of Light..</p>
          <p className="text-xl text-blue-100 mb-8 max-w-3xl leading-relaxed">
            Licensed process server in Chickasha, Oklahoma. Serving Grady County District Court, USAO, and surrounding communities. Rush and same-day available.
          </p>
      ...
      <div className="container mx-auto px-4 md:px-6 max-w-5xl py-12 space-y-10">
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-slate-700 to-slate-800 text-white">
            ...
            <p className="text-slate-300">Chickasha, Oklahoma</p>
          </div>
          <div className="p-8 space-y-4">
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-5">
              <p className="font-semibold text-lg text-gray-900">Grady County Courthouse</p>
              <p className="text-gray-700">326 W Choctaw Ave, Chickasha, OK 73018</p>
              <p className="text-gray-600 text-sm mt-1">📞 (405) 224-7388</p>
            ...
            <div className="bg-orange-50 border border-orange-200 rounded-xl p-4">
              ...
              <p className="text-orange-700 text-sm">USAO campus housing seasonal verification needed.</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-indigo-600 to-indigo-700 text-white">
            <h2 className="text-2xl font-bold mb-1">Where We Serve Papers in Chickasha</h2>
            <p className="text-indigo-100">Local coverage across Grady County</p>
          </div>
          <div className="p-8 grid md:grid-cols-2 gap-6">
            <div className="bg-gray-50 p-5 rounded-xl">
              <h3 className="font-semibold text-gray-900 mb-2">Downtown Chickasha</h3>
              <p className="text-gray-700 text-sm">Historic courthouse square and Festival of Light district.</p>
            </div>
            <div className="bg-gray-50 p-5 rounded-xl">
              <h3 className="font-semibold text-gray-900 mb-2">USAO Campus Area</h3>
              <p className="text-gray-700 text-sm">University housing and faculty residences.</p>
            </div>
            <div className="bg-gray-50 p-5 rounded-xl">
              <h3 className="font-semibold text-gray-900 mb-2">North Chickasha</h3>
              <p className="text-gray-700 text-sm">Residential neighborhoods along 4th St.</p>
            </div>
            <div className="bg-gray-50 p-5 rounded-xl">
              <h3 className="font-semibold text-gray-900 mb-2">South Chickasha</h3>
              <p className="text-gray-700 text-sm">Working-class homes near the railroad.</p>
            </div>
            <div className="bg-gray-50 p-5 rounded-xl">
              <h3 className="font-semibold text-gray-900 mb-2">Chickasha West</h3>
              <p className="text-gray-700 text-sm">Rural lots on the western edge.</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-emerald-600 to-emerald-700 text-white">
            ...
            <p className="text-emerald-100">Serving businesses and employees in Chickasha</p>
          </div>
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-blue-700 to-blue-800 text-white">
            <h2 className="text-2xl font-bold mb-1 flex items-center gap-2"><DollarSign className="h-6 w-6" /> Pricing for Chickasha</h2>
            <p className="text-blue-100">Flat rates — no hidden mileage fees in Grady County</p>
          </div>
          <div className="p-8">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
              ...
              <div className="bg-red-50 rounded-xl p-5 text-center border border-red-200">
                ...
                <p className="text-xs text-gray-400 mt-2">Immediate deployment · Chickasha coverage</p>
              </div>
            </div>
            <div className="text-center">
              ...
              <p className="text-xs text-gray-500 mt-3">All rates are flat — no hidden mileage fees in Grady County.</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-teal-600 to-teal-700 text-white">
            <h2 className="text-2xl font-bold mb-1">Chickasha FAQ</h2>
        ...
        <section className="bg-gradient-to-r from-red-600 to-red-700 text-white rounded-2xl shadow-lg">
          <div className="p-8 text-center">
            ...
            <h2 className="text-3xl font-bold mb-3">Emergency Process Service in Chickasha?</h2>
            <p className="text-xl mb-6 text-red-100">Available 24/7 for urgent legal document service across Grady County</p>
        ...
        <section className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-blue-600 to-blue-700 text-white">
            <h2 className="text-2xl font-bold mb-1 flex items-center gap-2"><MapPin className="h-6 w-6" /> Chickasha Service Area Map</h2>
            <p className="text-blue-100">GPS-verified coverage throughout Grady County</p>
          </div>
          <div className="p-8">
            <GoogleMapsEmbed
              ...
              cityName="Chickasha"
              state="Oklahoma"
              title="Chickasha Process Server Service Area"
            />
          </div>
        </section>
        ...
        <section className="bg-gradient-to-r from-blue-700 to-blue-800 text-white rounded-2xl shadow-lg">
          <div className="p-8 text-center">
            <h2 className="text-3xl font-bold mb-3">Ready to Serve Papers in Chickasha?</h2>
            <p className="text-xl mb-6 text-blue-100">GPS-tracked, notarized, court-ready — in Grady County.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
      ...
      <UnifiedSchema
        ...
        breadcrumbItems={[
          ...
          { name: 'Chickasha', item: 'https://justlegalsolutions.org/service-areas/chickasha' },
        ]}
      />
    </div>
  );
