...
export const metadata: Metadata = {
  title: 'Process Server Bixby, Oklahoma | Just Legal Solutions',
  description: 'Professional process server in Bixby, Oklahoma. Licensed, bonded, and insured. Same-day service available. Call (539) 367-6832.',
  keywords: 'process server Bixby, legal document delivery Bixby',
  openGraph: {
    title: 'Process Server Bixby, Oklahoma | Just Legal Solutions',
    description: 'Professional process server in Bixby, Oklahoma. Licensed, bonded, and insured. Same-day service available. Call (539) 367-6832.',
    url: 'https://justlegalsolutions.org/locations/bixby',
    type: 'website',
  },
};
...
export default function BixbyPage() {
  return (
    <div className="container mx-auto px-4 py-8">
          ...
          <h1>Professional Process Server in Bixby, Oklahoma</h1>
          <p>Just Legal Solutions provides professional process serving throughout Bixby and the surrounding Tulsa County area. Our licensed, bonded, and insured process servers deliver legal documents with reliability and discretion.</p>
          
          <h2>Process Serving Services in Bixby</h2>
          <ul>
          ...
          <p>Service Area: Bixby, Tulsa County, Oklahoma</p>
