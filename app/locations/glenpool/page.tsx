...
export const metadata: Metadata = {
  title: 'Process Server Glenpool, Oklahoma | Just Legal Solutions',
  description: 'Professional process server in Glenpool, Oklahoma. Licensed, bonded, and insured. Same-day service available. Call (539) 367-6832.',
  keywords: 'process server Glenpool, legal document delivery Glenpool',
  openGraph: {
    title: 'Process Server Glenpool, Oklahoma | Just Legal Solutions',
    description: 'Professional process server in Glenpool, Oklahoma. Licensed, bonded, and insured. Same-day service available. Call (539) 367-6832.',
    url: 'https://justlegalsolutions.org/locations/glenpool',
    type: 'website',
  },
};
...
export default function GlenpoolPage() {
  return (
    <div className="container mx-auto px-4 py-8">
          ...
          <h1>Professional Process Server in Glenpool, Oklahoma</h1>
          <p>Just Legal Solutions provides professional process serving throughout Glenpool and the surrounding Tulsa County area. Our licensed, bonded, and insured process servers deliver legal documents with reliability and discretion.</p>
          
          <h2>Process Serving Services in Glenpool</h2>
          <ul>
          ...
          <p>Service Area: Glenpool, Tulsa County, Oklahoma</p>
