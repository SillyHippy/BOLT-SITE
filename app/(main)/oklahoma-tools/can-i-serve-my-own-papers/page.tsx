        ...
        <section className="card p-6" aria-label="Decision tree questions">
          <div className="flex justify-between items-center mb-4">
            ...
            <button
              type="button"
              onClick={reset}
              className="text-sm text-blue-600 hover:text-blue-800 underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 rounded"
            >
              Reset all
            </button>
          </div>
              ...
              {[
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    className={`px-3 py-2.5 rounded text-sm font-medium border transition-colors text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-navy focus-visible:ring-offset-2 ${
                    caseType === opt.value
