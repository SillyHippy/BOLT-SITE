...
const faqs = [
    ...
    { question: "Can someone other than the named person accept legal papers?", answer: "Under 12 O.S. § 2004(C)(1), substituted (abode) service may be used in some civil cases by leaving papers with a person at least 15 years old who resides at the respondent's usual place of abode, when that method is allowed by law. Title 12 does not require a fixed number of prior personal attempts before residential substituted service. Subpoenas, service on government agencies, and service on corporations require personal delivery to specified persons—not residential sub-service." },
