...
import { FAQ_HUB_CATEGORIES, FAQ_HUB_TOTAL, allFaqItems } from '@/data/faq-hub';
import {
  Phone,
  Shield,
  Clock,
...
const faqCategories = FAQ_HUB_CATEGORIES.map((cat) => ({
  ...cat,
  icon: FAQ_ICON_MAP[cat.iconName],
}));
  ...
  return (
    <>
      ...
      <UnifiedSchema
        ...
        url="https://justlegalsolutions.org/faq"
        title="Oklahoma Process Server & Notary FAQ - All Your Questions Answered | Just Legal Solutions"
        description="Complete FAQ for Oklahoma process serving and notary services. 90+ questions answered on pricing, timelines, licensing, GPS proof, coverage, and notary requirements."
      ...
      <main className="min-h-screen bg-gradient-to-b from-slate-50 to-white font-[Inter,system-ui,sans-serif]">
        ...
        <section className="bg-gradient-to-br from-[#1e3a5f] via-blue-800 to-cyan-700 text-white pt-24 pb-16">
          <div className="container mx-auto px-4 max-w-5xl">
            ...
            <p className="text-lg text-blue-100 mb-8 leading-relaxed">
              {FAQ_HUB_TOTAL} questions answered in plain English. If your question is not here, call us
              at{' '}
        ...
        <div className="container mx-auto px-4 max-w-4xl pb-8">
          <LastUpdated pathname="/faq" label="Last reviewed" className="text-sm text-gray-500" />
        </div>
      </main>
      <Footer />
    </>
