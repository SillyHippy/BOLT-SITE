...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        images: [{ url: 'https://justlegalsolutions.org/og-image.webp', width: 1200, height: 630, alt: 'Tulsa County Divorce Process Serving' }],
    },
