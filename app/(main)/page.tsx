...
// Dynamically import the heavy ReviewWidget client component (which includes multiple icons and state logic)
// to reduce the initial JavaScript bundle size and improve page load metrics.
