...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Process Server Porter | Wagoner County Legal Document Service',
    description: 'Professional process server in Porter, Oklahoma. Expert legal document delivery in Wagoner County. Licensed and bonded. Call (539) 367-6832.',
    url: 'https://justlegalsolutions.org/process-server-porter',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Just Legal Solutions - Process Server Porter | Wagoner County Legal Document Service'
      }
    ],
    locale: 'en_US',
    type: 'website'
  ...
  alternates: {
    canonical: 'https://justlegalsolutions.org/process-server-porter'
  },
};
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <EnhancedBreadcrumbSchema items={[
        ...
        { name: "process server porter", url: "/process-server-porter" }
      ]} />
      
      <EnhancedFAQSchema 
        pageTitle="process server porter in Oklahoma"
        faqs={generateProcessServingFAQs("Oklahoma", "Process Serving")}
      />
      
      <EnhancedServiceSchema 
        serviceName="process server porter"
      ...
      <PerformanceSchema 
        pageName="process server porter - Oklahoma"
        pageUrl="/process-server-porter"
        loadTime={2.0}
