...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Process Server Oakhurst | Tulsa County Legal Document Service',
    description: 'Professional process server in Oakhurst, Oklahoma. Expert legal document delivery in Sand Springs area. Licensed and bonded. Call (539) 367-6832.',
    url: 'https://justlegalsolutions.org/process-server-oakhurst',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Just Legal Solutions - Process Server Oakhurst | Tulsa County Legal Document Service'
      }
    ],
    locale: 'en_US',
    type: 'website'
  ...
  alternates: {
    canonical: 'https://justlegalsolutions.org/process-server-oakhurst'
  },
};
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <EnhancedBreadcrumbSchema items={[
        ...
        { name: "process server oakhurst", url: "/process-server-oakhurst" }
      ]} />
      
      <EnhancedFAQSchema 
        pageTitle="process server oakhurst in Oklahoma"
        faqs={generateProcessServingFAQs("Oklahoma", "Process Serving")}
      />
      
      <EnhancedServiceSchema 
        serviceName="process server oakhurst"
      ...
      <PerformanceSchema 
        pageName="process server oakhurst - Oklahoma"
        pageUrl="/process-server-oakhurst"
        loadTime={2.0}
