...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Process Server Collinsville | Northern Tulsa County Legal Service',
    description: 'Professional process server in Collinsville, Oklahoma. Expert legal document delivery in northern Tulsa County. Licensed and bonded. Call (539) 367-6832.',
    url: 'https://justlegalsolutions.org/process-server-collinsville',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Just Legal Solutions - Process Server Collinsville | Northern Tulsa County Legal Service'
      }
    ],
    locale: 'en_US',
    type: 'website'
  ...
  alternates: {
    canonical: 'https://justlegalsolutions.org/process-server-collinsville'
  },
};
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <EnhancedBreadcrumbSchema items={[
        ...
        { name: "process server collinsville", url: "/process-server-collinsville" }
      ]} />
      
      <EnhancedFAQSchema 
        pageTitle="process server collinsville in Oklahoma"
        faqs={generateProcessServingFAQs("Oklahoma", "Process Serving")}
      />
      
      <EnhancedServiceSchema 
        serviceName="process server collinsville"
      ...
      <PerformanceSchema 
        pageName="process server collinsville - Oklahoma"
        pageUrl="/process-server-collinsville"
        loadTime={2.0}
