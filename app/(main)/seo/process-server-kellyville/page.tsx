...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Process Server Kellyville | Creek County Legal Document Service',
    description: 'Professional process server in Kellyville, Oklahoma. Expert legal document delivery in Creek County. Licensed and bonded. Call (539) 367-6832.',
    url: 'https://justlegalsolutions.org/process-server-kellyville',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Just Legal Solutions - Process Server Kellyville | Creek County Legal Document Service'
      }
    ],
    locale: 'en_US',
    type: 'website'
  ...
  alternates: {
    canonical: 'https://justlegalsolutions.org/process-server-kellyville'
  },
};
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <EnhancedBreadcrumbSchema items={[
        ...
        { name: "process server kellyville", url: "/process-server-kellyville" }
      ]} />
      
      <EnhancedFAQSchema 
        pageTitle="process server kellyville in Oklahoma"
        faqs={generateProcessServingFAQs("Oklahoma", "Process Serving")}
      />
      
      <EnhancedServiceSchema 
        serviceName="process server kellyville"
      ...
      <PerformanceSchema 
        pageName="process server kellyville - Oklahoma"
        pageUrl="/process-server-kellyville"
        loadTime={2.0}
