...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Process Server Leonard | Tulsa County Legal Document Service',
    description: 'Professional process server in Leonard, Oklahoma. Expert legal document delivery in southern Tulsa County. Licensed and bonded. Call (539) 367-6832.',
    url: 'https://justlegalsolutions.org/process-server-leonard',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Just Legal Solutions - Process Server Leonard | Tulsa County Legal Document Service'
      }
    ],
    locale: 'en_US',
    type: 'website'
  ...
  alternates: {
    canonical: 'https://justlegalsolutions.org/process-server-leonard'
  },
};
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <EnhancedBreadcrumbSchema items={[
        ...
        { name: "process server leonard", url: "/process-server-leonard" }
      ]} />
      
      <EnhancedFAQSchema 
        pageTitle="process server leonard in Oklahoma"
        faqs={generateProcessServingFAQs("Oklahoma", "Process Serving")}
      />
      
      <EnhancedServiceSchema 
        serviceName="process server leonard"
      ...
      <PerformanceSchema 
        pageName="process server leonard - Oklahoma"
        pageUrl="/process-server-leonard"
        loadTime={2.0}
