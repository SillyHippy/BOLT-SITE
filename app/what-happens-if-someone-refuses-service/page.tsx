...
const faqs = [
    ...
    { question: "What happens to the case if someone avoids service?", answer: "Oklahoma gives plaintiffs 180 days to complete service after filing (12 O.S. § 2004). Where permitted under § 2004(C)(1), residential substitute service may be used at the dwelling without a fixed number of prior personal attempts. Service by publication under § 2004(C)(3) requires court approval and due diligence. Subpoenas and entity or government service require personal delivery. The case does not go away." },
];
...
export default function RefusedServicePage() {
    return (
        <>
            ...
            <UnifiedSchema pageType="article" title="What Happens If Someone Refuses Service?" description="Refusing papers does NOT prevent valid service in Oklahoma. Learn about drop service and alternatives." url="https://justlegalsolutions.org/what-happens-if-someone-refuses-service" image="https://justlegalsolutions.org/image-pack/images/image-002-home-og.webp" keywords={['refuse to accept papers', 'can you refuse service', 'dodging process server']} reviewCount={156} services={['Process Serving', 'Skip Tracing', 'Same-Day Rush Service']} breadcrumbs={[{ name: 'Home', url: '/' }, { name: 'What Happens If Someone Refuses Service?', url: '/what-happens-if-someone-refuses-service' }]} />
        </>
    );
}
