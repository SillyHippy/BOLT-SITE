...
export const metadata = {
  ...
  openGraph: {
    ...
    type: 'website',
    locale: 'en_US',
    images: [{ url: 'https://justlegalsolutions.org/image-pack/images/image-015-urgent-process-server-hero.webp', width: 1200, height: 630, alt: 'Just Legal Solutions - Professional Process Serving in Oklahoma' }],
  },
};
      ...
      <main className="container mx-auto px-4 py-8 mt-12">
        <section className="flex flex-col md:flex-row items-start gap-8 mb-10">
          <div className="flex-1 min-w-0">
            ...
            <div className="mt-2 text-gray-600 text-sm mb-4">Or email: <a href="/contact" className="underline text-blue-700">info@JustLegalSolutions.org</a></div>
