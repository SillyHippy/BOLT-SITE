...
## 2026-07-21 - Added explicit focus indicators to radio group buttons
**Learning:** In `can-i-serve-my-own-papers` wizard, the custom radio buttons (which function as a radio group) were lacking explicit focus-visible classes, making them difficult to navigate via keyboard for accessibility.
**Action:** When creating custom interactive radio group or selection buttons, ensure they have explicit `focus-visible:ring-2` (and `focus-visible:outline-none`) classes applied so keyboard users can see what is currently focused.
