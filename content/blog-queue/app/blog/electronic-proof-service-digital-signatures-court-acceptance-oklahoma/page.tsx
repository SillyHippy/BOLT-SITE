...
export const metadata: Metadata = {
  ...
  other: {
    ...
    'ai-summary': 'Yes. Under Oklahoma\\\'s Uniform Electronic Transactions Act (12A O.S.',
    'ai-key-facts': 'Are digital signatures legally valid on proof of service documents in Oklahoma courts: Yes; What format must an electronic signature use on Oklahoma court documents: Oklahoma E-Filing Rule 4 requires the "/s/" for...; Can a process server electronically notarize an affidavit of service in Oklahoma: Yes, through two legally recognized methods; Is electronic service of process allowed for initial service of a summons in Oklahoma: No',
  },
};
