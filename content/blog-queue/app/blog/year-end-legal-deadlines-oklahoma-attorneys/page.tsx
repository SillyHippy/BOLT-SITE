...
export const metadata: Metadata = {
  ...
  description: 'Oklahoma attorney year-end checklist: MCLE by Dec 31, 180-day service audits, court holiday math under 12 O.S. § 2006, OBA dues, notary renewal, and trust account reconciliation.',
  ...
  other: {
    ...
    'ai-summary':
      'December deadlines for Oklahoma attorneys: 12 MCLE hours by Dec 31, June–July filings hitting the 180-day service rule, holiday filing math under 12 O.S. § 2006, and February OBA dues and MCLE reporting.',
    'ai-key-facts':
      '12 CLE credits including 2 ethics due Dec 31; MCLE reported by Feb 15; OBA 2026 dues due Feb 17, 2026; 12 O.S. § 2004(I) 180-day service hits year-end for mid-summer filings; § 2006 extends day-count deadlines on holidays but not most SOL expirations; Courts closed Dec 24–25 and Jan 1',
  },
};
  ...
  return (
    <>
      <UnifiedSchema
        ...
        pageDescription="Oklahoma attorney year-end checklist: MCLE by Dec 31, 180-day service audits, court holiday math under 12 O.S. § 2006, OBA dues, notary renewal, and trust account reconciliation."
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <div className="bg-green-50 border-2 border-green-300 p-4 rounded-lg mb-6 max-w-3xl mx-auto text-left">
            ...
            <p className="text-gray-800">
              Finish <strong>12 MCLE hours (2 ethics)</strong> by <strong>December 31</strong>, audit{' '}
              <strong>June–July filings</strong> for the <strong>180-day</strong> rule under{' '}
              <strong>12 O.S. § 2004(I)</strong> before holiday closures, use <strong>§ 2006</strong> for
              day-count deadline extensions (not most <strong>SOL</strong> dates), and calendar{' '}
              <strong>MCLE reporting (Feb 15)</strong> and <strong>OBA dues (Feb 17, 2026)</strong>.
            </p>
