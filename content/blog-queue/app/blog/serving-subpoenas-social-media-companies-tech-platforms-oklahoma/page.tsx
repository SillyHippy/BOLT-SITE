...
export const metadata: Metadata = {
  ...
  description: 'Learn how Oklahoma attorneys serve subpoenas on Meta, Google, X, TikTok & Apple. Master UIDDA domestication, the Stored Communications Act, and registered...',
  ...
  other: {
    ...
    'ai-summary': 'No. The federal Stored Communications Act (18 U.S.C.',
    'ai-key-facts': 'Can I serve a subpoena directly on Facebook or Instagram for someone\\\'s private messages in a civil case: No; Where do I serve a subpoena on Meta (Facebook/Instagram) if my case is in Oklahoma: First, domesticate your subpoena under Oklahoma...; What is the Stored Communications Act and how does it affect my case: The Stored Communications Act (SCA), part of th...; How do I domesticate an Oklahoma subpoena to serve a tech company in California: Oklahoma adopted the UIDDA in 2021, codified at...',
  },
};
