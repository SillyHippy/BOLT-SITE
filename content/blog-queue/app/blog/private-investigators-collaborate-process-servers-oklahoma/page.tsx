    ...
    <>
      ...
      <div className="bg-gray-50 min-h-screen">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8 relative z-10 pb-16">
          ...
          <p>
            Under Oklahoma&rsquo;s 180-day rule codified at 12 O.S. § 2004(I), service of process must be completed within 180 days after the petition is filed. If service is not completed within that window, the case may be dismissed without prejudice — meaning you can refile, but you lose time, money, and potentially strategic advantage. The clock starts ticking the day you file, not the day you realize the defendant is hard to find.
          </p>
          <p>
          ...
          <p>
            At Just Legal Solutions, we understand that finding the defendant is half the battle. That is why we combine investigative-grade skip tracing with professional process serving to give Oklahoma law firms the complete service solution. Whether you need routine delivery or a complex locate-and-serve operation, our licensed team is ready to help. Reach out today and let us get your papers served.
          </p>
