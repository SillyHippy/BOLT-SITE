...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: 'en_US',
    type: 'article',
    images: [{ url: 'https://justlegalsolutions.org/images/jls-logo.webp', width: 1200, height: 630, alt: 'Oklahoma notary vs attorney comparison guide by Just Legal Solutions' }],
  },
  ...
  other: {
    ...
    'ai-summary': 'Guide to differences between Oklahoma notaries and attorneys covering their roles, limitations, costs, and when to use each professional.',
    'ai-key-facts': 'Notaries witness signatures and administer oaths; notaries cannot provide legal advice; attorneys offer legal advice and representation; cost differences are significant; UPL rules protect consumers in Oklahoma',
  },
};
