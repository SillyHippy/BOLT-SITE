...
export const metadata: Metadata = {
  ...
  description: 'Serve foreign insurers on the Oklahoma Insurance Commissioner under 36 O.S. § 621—not OID for subpoenas. OID rules, adjuster subpoenas, and witness fees.',
  ...
  other: {
    ...
    'ai-summary':
      'Foreign insurers need OID Commissioner service under 36 O.S. § 621 with three copies and a $20 fee; subpoenas go directly to the insurer—never through OID—and adjuster depositions follow 12 O.S. § 3230(B) county limits.',
    'ai-key-facts':
      '36 O.S. § 621(A) excludes subpoenas from OID statutory-agent service; Foreign insurer lawsuits require three copies and a $20 fee to the Insurance Commissioner; Subpoena witness fees under 28 O.S. § 81 are $10 per day plus mileage at service; Out-of-state subpoenas domesticate under Oklahoma UIDDA at 12 O.S. §§ 3250 et seq.',
  },
};
  ...
  return (
    <>
      <UnifiedSchema
        ...
        pageDescription="Serve foreign insurers on the Oklahoma Insurance Commissioner under 36 O.S. § 621—not OID for subpoenas. OID rules, adjuster subpoenas, and witness fees."
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <div className="bg-green-50 border-2 border-green-300 p-4 rounded-lg mb-6 max-w-3xl mx-auto text-left">
            ...
            <p className="text-gray-800">
              <strong>Foreign insurers</strong> get summons service on the{' '}
              <strong>Oklahoma Insurance Commissioner</strong> under <strong>36 O.S. § 621</strong> (three
              copies, $20 fee)—but <strong>subpoenas never go through OID</strong>. Serve subpoenas on the
              insurer directly, tender <strong>witness fees</strong> when required, and follow{' '}
              <strong>12 O.S. § 3230(B)</strong> for adjuster deposition locations.
            </p>
