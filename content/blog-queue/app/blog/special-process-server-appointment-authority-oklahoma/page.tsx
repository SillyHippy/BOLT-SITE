...
export const metadata: Metadata = {
  ...
  description:
    'Oklahoma judges may appoint a special process server under 12 O.S. § 2004 for one case—limited authority, no license, but mandatory § 2004(G)(2) affidavits.',
  ...
  other: {
    ...
    'ai-summary':
      'Under 12 O.S. § 2004 Oklahoma courts shall freely appoint special process servers for civil process except subpoenas—authority is case-specific, with no 158.1 license or bond, but servers must file affidavits under § 2004(G)(2) listing name, date, place, and method.',
    'ai-key-facts':
      '12 O.S. § 2004 allows sheriff, licensed server, or court-appointed server for non-subpoena civil process; Special appointees need signed order before service—unlicensed service is misdemeanor under § 158.1(I); Subpoenas served by any non-party 18+ under § 2004.1 without appointment; § 2004(G)(2) affidavit required for non-licensed servers; Cannot serve warrants or executions per Supreme Court Rule 41',
  },
};
  ...
  return (
    <>
      <UnifiedSchema
        ...
        pageDescription="Oklahoma judges may appoint a special process server under 12 O.S. § 2004 for one case—limited authority, no license, but mandatory § 2004(G)(2) affidavits."
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <div className="bg-green-50 border-2 border-green-300 p-4 rounded-lg mb-6 max-w-3xl mx-auto text-left">
            ...
            <p className="text-gray-800">
              A <strong>special process server</strong> is a judge-appointed server for <strong>one case</strong> under{' '}
              <strong>12 O.S. § 2004</strong>—not a statewide license; use a <strong>licensed server</strong> under § 158.1
              for routine work, and ensure appointees carry the <strong>court order</strong> plus a{' '}
              <strong>§ 2004(G)(2) affidavit</strong> on return.
            </p>
