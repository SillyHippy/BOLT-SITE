...
export const metadata: Metadata = {
  ...
  description: "Oklahoma mechanic's liens & bond claims: 75-day pre-lien notice, 90-day filing, dual surety notice, foreclosure service—Title 42 and 61 deadlines explained.",
  ...
  other: {
    ...
    'ai-summary': 'Oklahoma construction lien and bond timelines—75-day pre-lien notice, 90-day filing, dual surety notice on public jobs, skip-tracing dissolved LLCs, and multi-party foreclosure service under Title 42 and 61.',
    'ai-key-facts': 'Pre-lien notice within 75 days for most subcontractors under 42 O.S. § 142.6; Lien statements due in 90 days (subs) or 4 months (original contractors); Bond claim notice must go to contractor and surety within 90 days under 61 O.S. § 2; Foreclosure suits require proper service within one year and generally within 180 days of filing under 12 O.S. § 2004(I)',
  },
};
  ...
  return (
    <>
      <UnifiedSchema
        ...
        pageDescription="Oklahoma mechanic's liens & bond claims: 75-day pre-lien notice, 90-day filing, dual surety notice, foreclosure service—Title 42 and 61 deadlines explained."
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <div className="bg-green-50 border-2 border-green-300 p-4 rounded-lg mb-6 max-w-3xl mx-auto text-left">
            ...
            <p className="text-gray-800">
              Oklahoma construction claims live or die on notice and service deadlines. Most subcontractors must send a{' '}
              <strong>75-day pre-lien notice</strong>, file a verified lien within <strong>90 days</strong> of last work, and
              serve every necessary party in a <strong>one-year foreclosure</strong>. Public jobs require{' '}
              <strong>90-day notice to both the contractor and surety</strong>. Licensed servers with skip-tracing help
              document delivery before Oklahoma&apos;s <strong>180-day</strong> service limits expire.
            </p>
