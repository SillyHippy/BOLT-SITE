    ...
    <>
      ...
      <div className="bg-gray-50 min-h-screen">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8 relative z-10 pb-16">
          ...
          <p>
            Many subcontractors operate from pickup trucks and cell phones with no permanent office. Due diligence requires attempting service at the last-known address, attempting registered agent service, and checking Secretary of State records before a motion for substituted service can be pursued. Our team uses <Link href="/blog/ai-skip-tracing-finding-evasive-defendants" className="text-blue-600 hover:underline">advanced skip-tracing techniques</Link> to locate evasive defendants before deadlines expire. One critical warning: never attempt improvised service methods without court approval — improper service can void a lien or bond claim entirely.
          </p>
