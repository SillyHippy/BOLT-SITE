...
export const metadata: Metadata = {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Oklahoma Notary Public Act explained by Just Legal Solutions',
      },
    ],
  },
  alternates: {
  ...
  other: {
    ...
    'ai-summary':
      'Explanation of Oklahoma Notary Public Act covering qualifications, permitted acts, prohibited activities, liability, and recent law changes.',
    'ai-key-facts':
      'Oklahoma Notary Public Act codified in Title 49 O.S.; notaries cannot provide legal advice; electronic notarization is permitted under specific rules; misconduct carries penalties; commission verification available through Secretary of State',
  },
};
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'You can verify a notary\'s commission status through the Oklahoma Secretary of State\'s office. The Secretary of State maintains a public database of all active notary commissions in the state. You will need the notary\'s name or commission number to perform the search. This verification step is especially important for documents involving significant financial or legal transactions.',
  },
  {
    question:
