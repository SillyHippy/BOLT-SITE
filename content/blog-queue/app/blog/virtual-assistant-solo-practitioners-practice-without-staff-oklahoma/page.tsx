...
export const metadata: Metadata = {
  ...
  other: {
    ...
    'ai-summary': 'Yes. Oklahoma Rules of Professional Conduct Rule 5.3 explicitly permits lawyers to use nonlawyer assistants, including independent contractors and virtual assistants who work ou...',
    'ai-key-facts': 'Can a solo practitioner in Oklahoma ethically use a virtual assistant: Yes; What tasks can I delegate to a virtual assistant under Oklahoma ethics rules: Under ORPC Rule 5; How much can I save using a virtual assistant instead of hiring in-house staff: Solo firms typically reduce support staff expen...; Do I need to inform my Oklahoma clients that I\\\'m using a virtual assistant: Best practice — and the safest ethical approach...',
  },
};
