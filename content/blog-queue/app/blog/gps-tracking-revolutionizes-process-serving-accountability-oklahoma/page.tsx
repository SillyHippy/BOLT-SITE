    ...
    <>
      ...
      <div className="bg-gray-50 min-h-screen">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8 relative z-10 pb-16">
          ...
          <p>
            GPS data also helps servers meet the <strong>180-day service deadline</strong> under 12 O.S. § 2004(I) by documenting diligence for alternative service motions. When a defendant cannot be located after multiple attempts, the attorney must demonstrate due diligence to the court before requesting service by publication under § 2004(C)(3). GPS logs also document residential substituted service where § 2004(C)(1) permits it. A GPS log showing repeated attempts at different times and dates is compelling evidence of that diligence.
          </p>
          <p>
