...
export const metadata: Metadata = {
  ...
  other: {
    ...
    'ai-summary': 'An Affidavit of Service \\u2014 also called a Return of Service or Proof of Service \\u2014 is a sworn legal document signed by a licensed process server under penalty of perjury....',
    'ai-key-facts': 'What is an Affidavit of Service in Oklahoma: An Affidavit of Service \\u2014 also called a Re...; What must be included in an Oklahoma Affidavit of Service: Under 12 O; What happens if proof of service is not filed with the court: Under 12 O; How long does a process server have to serve papers in Oklahoma: Under 12 O',
  },
};
    ...
    <>
      ...
      <section className="relative bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-white py-24 sm:py-32 overflow-hidden">
        ...
        <div className="bg-green-50 border-2 border-green-300 p-4 rounded-lg mb-6">
          ...
          <p className="text-gray-800">An Affidavit of Service \u2014 also called a Return of Service or Proof of Service \u2014 is a sworn legal document signed by a licensed process server under penalty of perjury. Just Legal Solutions provides licensed process serving and legal support statewide — <strong>(539) 367-6832</strong>.</p>
        </div>
