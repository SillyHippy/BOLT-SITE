    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        ...
        <section className="bg-white rounded-lg shadow-sm p-6 mb-8">
          ...
          <p className="mb-4">
            When evaluating courier costs, consider the value of the service in context. A missed filing deadline can result in case dismissal, sanctions, or loss of client confidence. A compromised confidential document can lead to malpractice exposure. The cost of professional legal courier service is minimal compared to the risks of relying on untracked, unbonded delivery methods. For current pricing on all our delivery services, view our pricing page. We are committed to transparent pricing with no hidden fees.
          </p>
        </section>
