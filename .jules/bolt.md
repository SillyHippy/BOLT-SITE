...
## 2026-05-24 - Shifting Computationally Expensive Operations on Static Data to Fast O(1) Lookups
**Learning:** For computationally expensive operations on static data (e.g., calculating haversine distances and sorting items in `lib/county-neighbors.ts`), performing these operations repeatedly during renders or static generation is highly inefficient.
